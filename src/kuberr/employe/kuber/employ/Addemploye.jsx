...
import CuberUpdate from "../office -practise/cuber";
...
export default function Addemploye() {
  ...
  return (
    ...
    <div _ngcontent-hni-c142 className={`  bg2 ${isOpen ? "bg2--open " : ""}`}>
                      <div _ngcontent-oko-c240 className="block-header">
                        <app-breadcrumb _ngcontent-oko-c240 _nghost-oko-c141>
                      ...
                      <div _ngcontent-oko-c240 className="row clearfix">
                        <div _ngcontent-oko-c240 className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div _ngcontent-oko-c240 className="card">
                            <div _ngcontent-oko-c240 className="header">
                              <h2 _ngcontent-oko-c240>Add Employee</h2>
                            </div>
                            <CuberUpdate/>
                            </div>
                        </div>
