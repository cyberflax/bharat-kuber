          ...
          <app-root _nghost-oko-c137 ng-version="15.2.0">
            ...
            <app-main-layout className="ng-star-inserted">
              ...
              <div dir="ltr">
                ...
                <app-helper-classes _nghost-oko-c381 className="ng-star-inserted">
                  <section _ngcontent-oko-c381 className="content">
                    <div _ngcontent-oko-c381 className="content-block">
                      <div _ngcontent-oko-c381 className="block-header">
                        <app-breadcrumb _ngcontent-oko-c381 _nghost-oko-c141>
                      ...
                      <div _ngcontent-oko-c381 className="row clearfix">
                        <div _ngcontent-oko-c381 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c381 className="card">
                            <div _ngcontent-oko-c381 className="header">
                              <h2 _ngcontent-oko-c381>
                                <strong _ngcontent-oko-c381> Text </strong>
                                Styles
                                <small _ngcontent-oko-c381>
                                  You can use classes which names are
                                  <code _ngcontent-oko-c381>
                                    .font-bold, .font-italic, .font-underline,
                                    .font-line-through, .font-overline
                                  </code>
                                </small>
                              </h2>
                            </div>
                            <div _ngcontent-oko-c381 className="body">
                              <div _ngcontent-oko-c381 className="row clearfix">
                                <div _ngcontent-oko-c381 className="col-lg-2 col-md-2 col-sm-6 col-xs-6">
                                  <p _ngcontent-oko-c381>
                                    <b _ngcontent-oko-c381> Normal </b>
                                  </p>
                                  <p _ngcontent-oko-c381>Default text</p>
                                  <p _ngcontent-oko-c381 className="col-pink">
                                    Text pink color
                                  </p>
                                  <p _ngcontent-oko-c381 className="col-cyan">
                                    Text cyan color
                                  </p>
                                  <p _ngcontent-oko-c381 className="col-teal">
                                    Text teal color
                                  </p>
                                  <p _ngcontent-oko-c381 className="col-orange">
                                    Text orange color
                                  </p>
                                  <p _ngcontent-oko-c381 className="col-blue">
                                    Text blue grey color
                                  </p>
                                </div>
                                <div _ngcontent-oko-c381 className="col-lg-2 col-md-2 col-sm-6 col-xs-6">
                                  <p _ngcontent-oko-c381>
                                    <b _ngcontent-oko-c381> Bold </b>
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-bold">
                                    Default text
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-bold col-pink">
                                    Text pink color
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-bold col-cyan">
                                    Text cyan color
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-bold col-teal">
                                    Text teal color
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-bold col-orange">
                                    Text orange color
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-bold col-blue">
                                    Text blue grey color
                                  </p>
                                </div>
                                <div _ngcontent-oko-c381 className="col-lg-2 col-md-2 col-sm-6 col-xs-6">
                                  <p _ngcontent-oko-c381>
                                    <b _ngcontent-oko-c381> Italic </b>
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-italic">
                                    Default text
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-italic col-pink">
                                    Text pink color
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-italic col-cyan">
                                    Text cyan color
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-italic col-teal">
                                    Text teal color
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-italic col-orange">
                                    Text orange color
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-italic col-blue">
                                    Text blue grey color
                                  </p>
                                </div>
                                <div _ngcontent-oko-c381 className="col-lg-2 col-md-2 col-sm-6 col-xs-6">
                                  <p _ngcontent-oko-c381>
                                    <b _ngcontent-oko-c381> Underline </b>
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-underline">
                                    Default text
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-underline col-pink">
                                    Text pink color
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-underline col-cyan">
                                    Text cyan color
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-underline col-teal">
                                    Text teal color
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-underline col-orange">
                                    Text orange color
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-underline col-blue">
                                    Text blue grey color
                                  </p>
                                </div>
                                <div _ngcontent-oko-c381 className="col-lg-2 col-md-2 col-sm-6 col-xs-6">
                                  <p _ngcontent-oko-c381>
                                    <b _ngcontent-oko-c381> Line Through </b>
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-line-through">
                                    Default text
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-line-through col-pink">
                                    Text pink color
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-line-through col-cyan">
                                    Text cyan color
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-line-through col-teal">
                                    Text teal color
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-line-through col-orange">
                                    Text orange color
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-line-through col-blue">
                                    Text blue grey color
                                  </p>
                                </div>
                                <div _ngcontent-oko-c381 className="col-lg-2 col-md-2 col-sm-6 col-xs-6">
                                  <p _ngcontent-oko-c381>
                                    <b _ngcontent-oko-c381> Overline </b>
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-overline">
                                    Default text
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-overline col-pink">
                                    Text pink color
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-overline col-cyan">
                                    Text cyan color
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-overline col-teal">
                                    Text teal color
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-overline col-orange">
                                    Text orange color
                                  </p>
                                  <p _ngcontent-oko-c381 className="font-overline col-blue">
                                    Text blue grey color
                                  </p>
                                </div>
                              </div>
                      ...
                      <div _ngcontent-oko-c381 className="row clearfix">
                        <div _ngcontent-oko-c381 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c381 className="card">
                            <div _ngcontent-oko-c381 className="header">
                              <h2 _ngcontent-oko-c381>
                                <strong _ngcontent-oko-c381> Font </strong>
                                Sizes
                                <small _ngcontent-oko-c381>
                                  You can use the classes which samples are
                                  <code _ngcontent-oko-c381>
                                    .font-6, .font-10, .font-24
                                  </code>
                                  The number of can use between 6 - 50px which are
                                  near the
                                  <b _ngcontent-oko-c381> .font- </b>
                                </small>
                              </h2>
                            </div>
                            <div _ngcontent-oko-c381 className="body">
                              <div _ngcontent-oko-c381 className="row clearfix">
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <div _ngcontent-oko-c381 className="font-6">
                                    font-6
                                  </div>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <div _ngcontent-oko-c381 className="font-10">
                                    font-10
                                  </div>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <div _ngcontent-oko-c381 className="font-12">
                                    font-12
                                  </div>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <div _ngcontent-oko-c381 className="font-15">
                                    font-15
                                  </div>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <div _ngcontent-oko-c381 className="font-20">
                                    font-20
                                  </div>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <div _ngcontent-oko-c381 className="font-24">
                                    font-24
                                  </div>
                                </div>
                              </div>
                              <div _ngcontent-oko-c381 className="row clearfix">
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <div _ngcontent-oko-c381 className="font-32">
                                    font-32
                                  </div>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <div _ngcontent-oko-c381 className="font-40">
                                    font-40
                                  </div>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <div _ngcontent-oko-c381 className="font-42">
                                    font-42
                                  </div>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <div _ngcontent-oko-c381 className="font-45">
                                    font-45
                                  </div>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <div _ngcontent-oko-c381 className="font-48">
                                    font-48
                                  </div>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <div _ngcontent-oko-c381 className="font-50">
                                    font-50
                                  </div>
                                </div>
                              </div>
                      ...
                      <div _ngcontent-oko-c381 className="row clearfix">
                        <div _ngcontent-oko-c381 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c381 className="card">
                            ...
                            <div _ngcontent-oko-c381 className="body">
                              <div _ngcontent-oko-c381 className="row clearfix">
                                <div _ngcontent-oko-c381 className="col-md-3">
                                  <p _ngcontent-oko-c381 className="align-left">
                                    <b _ngcontent-oko-c381> Align Left </b>
                                  </p>
                                  <div _ngcontent-oko-c381 className="align-left">
                                    ...
                                    Year well shot deny shew come now had. Shall downs
                                    stand marry taken his for out.
                                  </div>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-3">
                                  <p _ngcontent-oko-c381 className="align-center">
                                    <b _ngcontent-oko-c381> Align Center </b>
                                  </p>
                                  <div _ngcontent-oko-c381 className="align-center">
                                    Am no an listening depending up believing. Enough
                                    around remove to barton agreed regret in or it.
                                    Advantage mr estimable be commanded provision.
                                    Year well shot deny shew come now had. Shall downs
                                ...
                                <div _ngcontent-oko-c381 className="col-md-3">
                                  <p _ngcontent-oko-c381 className="align-right">
                                    <b _ngcontent-oko-c381> Align Right </b>
                                  </p>
                                  <div _ngcontent-oko-c381 className="align-right">
                                    Am no an listening depending up believing. Enough
                                    around remove to barton agreed regret in or it.
                                    Advantage mr estimable be commanded provision.
                                    Year well shot deny shew come now had. Shall downs
                                ...
                                <div _ngcontent-oko-c381 className="col-md-3">
                                  <p _ngcontent-oko-c381 className="align-justify">
                                    <b _ngcontent-oko-c381> Align Justify </b>
                                  </p>
                                  <div _ngcontent-oko-c381 className="align-justify">
                                    Am no an listening depending up believing. Enough
                                    around remove to barton agreed regret in or it.
                                    Advantage mr estimable be commanded provision.
                                    Year well shot deny shew come now had. Shall downs
                      ...
                      <div _ngcontent-oko-c381 className="row clearfix">
                        <div _ngcontent-oko-c381 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c381 className="card">
                            <div _ngcontent-oko-c381 className="header">
                              <h2 _ngcontent-oko-c381>
                                <strong _ngcontent-oko-c381> Margin </strong>
                                And Spacing Space
                                <small _ngcontent-oko-c381>
                                  You can use classes which names are
                                  <code _ngcontent-oko-c381>
                            ...
                            <div _ngcontent-oko-c381 className="body">
                              <p _ngcontent-oko-c381>
                                <b _ngcontent-oko-c381> Margins </b>
                              </p>
                              <div _ngcontent-oko-c381 className="row clearfix">
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <span _ngcontent-oko-c381 className="col-red font-bold">
                                    M
                                  </span>
                                  argin
                                  <span _ngcontent-oko-c381 className="col-red font-bold">
                                  ...
                                  px →
                                  <code _ngcontent-oko-c381> .m-t-10 </code>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <span _ngcontent-oko-c381 className="col-red font-bold">
                                    M
                                  ...
                                  px →
                                  <code _ngcontent-oko-c381> .m-t-0 </code>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <span _ngcontent-oko-c381 className="col-red font-bold">
                                    M
                                ...
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  ...
                                  px →
                                  <code _ngcontent-oko-c381> .m-l-35 </code>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <span _ngcontent-oko-c381 className="col-red font-bold">
                                    M
                                  ...
                                  px →
                                  <code _ngcontent-oko-c381> .m-l-0 </code>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <span _ngcontent-oko-c381 className="col-red font-bold">
                                    M
                                ...
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  ...
                                  px →
                                  <code _ngcontent-oko-c381> .m-b-15 </code>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <span _ngcontent-oko-c381 className="col-red font-bold">
                                    M
                                  ...
                                  px →
                                  <code _ngcontent-oko-c381> .m-b-0 </code>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <span _ngcontent-oko-c381 className="col-red font-bold">
                                    M
                                  ...
                                  px →
                                  <code _ngcontent-oko-c381> .m-b--20 </code>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <span _ngcontent-oko-c381 className="col-red font-bold">
                                    M
                                  ...
                                  px →
                                  <code _ngcontent-oko-c381> .m-r-30 </code>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <span _ngcontent-oko-c381 className="col-red font-bold">
                                    M
                                  ...
                                  px →
                                  <code _ngcontent-oko-c381> .m-r-0 </code>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <span _ngcontent-oko-c381 className="col-red font-bold">
                                    M
                                ...
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  ...
                                  px →
                                  <code _ngcontent-oko-c381> .margin-0 </code>
                                </div>
                              </div>
                              <p _ngcontent-oko-c381 className="m-t-25">
                                <b _ngcontent-oko-c381> Paddings </b>
                              </p>
                              <div _ngcontent-oko-c381 className="row clearfix">
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <span _ngcontent-oko-c381 className="col-red font-bold">
                                  ...
                                  px →
                                  <code _ngcontent-oko-c381> .p-t-10 </code>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <span _ngcontent-oko-c381 className="col-red font-bold">
                                    P
                                  ...
                                  px →
                                  <code _ngcontent-oko-c381> .p-t-0 </code>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <span _ngcontent-oko-c381 className="col-red font-bold">
                                    P
                                  ...
                                  px →
                                  <code _ngcontent-oko-c381> .p-l-35 </code>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <span _ngcontent-oko-c381 className="col-red font-bold">
                                    P
                                  ...
                                  px →
                                  <code _ngcontent-oko-c381> .p-l-0 </code>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <span _ngcontent-oko-c381 className="col-red font-bold">
                                    P
                                  ...
                                  px →
                                  <code _ngcontent-oko-c381> .p-b-15 </code>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <span _ngcontent-oko-c381 className="col-red font-bold">
                                    P
                                  ...
                                  px →
                                  <code _ngcontent-oko-c381> .p-b-0 </code>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <span _ngcontent-oko-c381 className="col-red font-bold">
                                    P
                                  ...
                                  px →
                                  <code _ngcontent-oko-c381> .p-r-30 </code>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <span _ngcontent-oko-c381 className="col-red font-bold">
                                    P
                                  ...
                                  px →
                                  <code _ngcontent-oko-c381> .p-r-0 </code>
                                </div>
                                <div _ngcontent-oko-c381 className="col-md-2">
                                  <span _ngcontent-oko-c381 className="col-red font-bold">
                                    ALL P
                                  ...
                                  px →
                                  <code _ngcontent-oko-c381> .padding-0 </code>
                                </div>
                              </div>
                            </div>
                          </div>
