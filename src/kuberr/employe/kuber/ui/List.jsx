          ...
          <app-root _nghost-oko-c137 ng-version="15.2.0">
            ...
            <app-main-layout className="ng-star-inserted">
              ...
              <div dir="ltr">
                ...
                <app-list-group _nghost-oko-c377 className="ng-star-inserted">
                  <section _ngcontent-oko-c377 className="content">
                    <div _ngcontent-oko-c377 className="content-block">
                      <div _ngcontent-oko-c377 className="block-header">
                        <app-breadcrumb _ngcontent-oko-c377 _nghost-oko-c141>
                      ...
                      <div _ngcontent-oko-c377 className="row clearfix">
                        <div _ngcontent-oko-c377 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c377 className="card">
                            <div _ngcontent-oko-c377 className="header">
                              <h2 _ngcontent-oko-c377>Basic list</h2>
                            </div>
                            <div _ngcontent-oko-c377 className="body">
                              <mat-list _ngcontent-oko-c377 aria-disabled="false" className="mat-mdc-list mat-mdc-list-base mdc-list" role="list">
                                <mat-list-item _ngcontent-oko-c377 aria-disabled="false" className="mat-mdc-list-item mdc-list-item mat-mdc-list-item-single-line mdc-list-item--with-one-line" role="listitem">
                                  <span className="mdc-list-item__content">
                                    <span className="mat-mdc-list-item-unscoped-content mdc-list-item__primary-text">
                                      Item 1
                                    </span>
                                  </span>
                                  <div className="mat-mdc-focus-indicator" />
                                </mat-list-item>
                                <mat-list-item _ngcontent-oko-c377 aria-disabled="false" className="mat-mdc-list-item mdc-list-item mat-mdc-list-item-single-line mdc-list-item--with-one-line" role="listitem">
                                  <span className="mdc-list-item__content">
                                    <span className="mat-mdc-list-item-unscoped-content mdc-list-item__primary-text">
                      ...
                      <div _ngcontent-oko-c377 className="row clearfix">
                        <div _ngcontent-oko-c377 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c377 className="card">
                            <div _ngcontent-oko-c377 className="header">
                              <h2 _ngcontent-oko-c377>List with selection</h2>
                            </div>
                            <div _ngcontent-oko-c377 className="body">
                              <mat-selection-list _ngcontent-oko-c377 aria-disabled="false" aria-multiselectable="true" className="mat-mdc-selection-list mat-mdc-list-base mdc-list" role="listbox">
                                <mat-list-option _ngcontent-oko-c377 aria-disabled="false" aria-selected="false" className="mat-mdc-list-item mat-mdc-list-option mdc-list-item mat-mdc-list-item-interactive mdc-list-item--with-trailing-checkbox mat-accent mat-mdc-list-item-single-line mdc-list-item--with-one-line ng-star-inserted" role="option" tabIndex={0}>
                                  {/* */}
                                  {/* */}
                                  {/* */}
                                  {/* */}
                                  ...
                                  <span className="mdc-list-item__end ng-star-inserted">
                                    <div className="mdc-checkbox ng-star-inserted">
                                      <input className="mdc-checkbox__native-control" type="checkbox" />
                                      <div className="mdc-checkbox__background">
                                        <svg aria-hidden="true" className="mdc-checkbox__checkmark" viewBox="0 0 24 24">
                                ...
                                <mat-list-option _ngcontent-oko-c377 aria-disabled="false" aria-selected="false" className="mat-mdc-list-item mat-mdc-list-option mdc-list-item mat-mdc-list-item-interactive mdc-list-item--with-trailing-checkbox mat-accent mat-mdc-list-item-single-line mdc-list-item--with-one-line ng-star-inserted" role="option" tabIndex={-1}>
                                  {/* */}
                                  {/* */}
                                  {/* */}
                                  {/* */}
                              ...
                              <p _ngcontent-oko-c377>Options selected: 0</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div _ngcontent-oko-c377 className="row clearfix">
                        <div _ngcontent-oko-c377 className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c377 className="card">
                            <div _ngcontent-oko-c377 className="header">
                              <h2 _ngcontent-oko-c377>
                                <strong _ngcontent-oko-c377> Basic </strong>
                                Examples
                              </h2>
                            </div>
                            <div _ngcontent-oko-c377 className="body">
                              <ul _ngcontent-oko-c377 className="list-group">
                                <li _ngcontent-oko-c377 className="list-group-item">
                                  Cras justo odio
                                </li>
                                <li _ngcontent-oko-c377 className="list-group-item">
                        ...
                        <div _ngcontent-oko-c377 className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c377 className="card">
                            <div _ngcontent-oko-c377 className="header">
                              <h2 _ngcontent-oko-c377>
                                <strong _ngcontent-oko-c377> Badges </strong>
                              </h2>
                            </div>
                            <div _ngcontent-oko-c377 className="body">
                              <ul _ngcontent-oko-c377 className="list-group">
                                <li _ngcontent-oko-c377 className="list-group-item">
                                  Cras justo odio
                                  <span _ngcontent-oko-c377 className="badge bg-pink">
                                    14 new
                                  </span>
                                </li>
                                <li _ngcontent-oko-c377 className="list-group-item">
                                  Dapibus ac facilisis in
                                  <span _ngcontent-oko-c377 className="badge bg-cyan">
                                    99 read
                                  </span>
                                </li>
                                <li _ngcontent-oko-c377 className="list-group-item">
                                  Morbi leo risus
                                  <span _ngcontent-oko-c377 className="badge bg-teal">
                                    99+
                                  </span>
                                </li>
                                <li _ngcontent-oko-c377 className="list-group-item">
                                  Porta ac consectetur ac
                                  <span _ngcontent-oko-c377 className="badge bg-orange">
                                    21
                                  </span>
                                </li>
                                <li _ngcontent-oko-c377 className="list-group-item">
                                  Vestibulum at eros
                                  <span _ngcontent-oko-c377 className="badge bg-purple">
                                    18
                                  </span>
                                </li>
                              </ul>
                      ...
                      <div _ngcontent-oko-c377 className="row clearfix">
                        <div _ngcontent-oko-c377 className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c377 className="card">
                            <div _ngcontent-oko-c377 className="header">
                              <h2 _ngcontent-oko-c377>
                                <strong _ngcontent-oko-c377> Linked </strong>
                                Items
                              </h2>
                            </div>
                            <div _ngcontent-oko-c377 className="body">
                              <div _ngcontent-oko-c377 className="list-group">
                                <a _ngcontent-oko-c377 className="list-group-item active" href="#" onclick="return false;">
                                  Cras justo odio
                                </a>
                                <a _ngcontent-oko-c377 className="list-group-item" href="#" onclick="return false;">
                                  Dapibus ac facilisis in
                                </a>
                                <a _ngcontent-oko-c377 className="list-group-item" href="#" onclick="return false;">
                                  Morbi leo risus
                        ...
                        <div _ngcontent-oko-c377 className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c377 className="card">
                            <div _ngcontent-oko-c377 className="header">
                              <h2 _ngcontent-oko-c377>
                                <strong _ngcontent-oko-c377> Button </strong>
                                Items
                              </h2>
                            </div>
                            <div _ngcontent-oko-c377 className="body">
                              <div _ngcontent-oko-c377 className="list-group">
                                <button _ngcontent-oko-c377 className="list-group-item" type="button">
                                  Cras justo odio
                                </button>
                                <button _ngcontent-oko-c377 className="list-group-item" type="button">
                                  Dapibus ac facilisis in
                      ...
                      <div _ngcontent-oko-c377 className="row clearfix">
                        <div _ngcontent-oko-c377 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c377 className="card">
                            <div _ngcontent-oko-c377 className="header">
                              <h2 _ngcontent-oko-c377>
                                <strong _ngcontent-oko-c377> Disabled </strong>
                                Items
                              </h2>
                            </div>
                            <div _ngcontent-oko-c377 className="body">
                              <div _ngcontent-oko-c377 className="list-group">
                                <a _ngcontent-oko-c377 className="list-group-item disabled" href="#" onclick="return false;">
                                  Cras justo odio
                                </a>
                                <a _ngcontent-oko-c377 className="list-group-item" href="#" onclick="return false;">
                                  Dapibus ac facilisis in
                      ...
                      <div _ngcontent-oko-c377 className="row clearfix">
                        <div _ngcontent-oko-c377 className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c377 className="card">
                            <div _ngcontent-oko-c377 className="header">
                              <h2 _ngcontent-oko-c377>
                                <strong _ngcontent-oko-c377> Contextual </strong>
                                Classes
                              </h2>
                            </div>
                            <div _ngcontent-oko-c377 className="body">
                              <ul _ngcontent-oko-c377 className="list-group">
                                <li _ngcontent-oko-c377 className="list-group-item list-group-item-success">
                                  Dapibus ac facilisis in
                                </li>
                                <li _ngcontent-oko-c377 className="list-group-item list-group-item-info">
                                  Cras sit amet nibh libero
                                </li>
                                <li _ngcontent-oko-c377 className="list-group-item list-group-item-warning">
                                  Porta ac consectetur ac
                                </li>
                                <li _ngcontent-oko-c377 className="list-group-item list-group-item-danger">
                                  Vestibulum at eros
                                </li>
                              </ul>
                            </div>
                        ...
                        <div _ngcontent-oko-c377 className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c377 className="card">
                            <div _ngcontent-oko-c377 className="header">
                              <h2 _ngcontent-oko-c377>
                                <strong _ngcontent-oko-c377> Contextual </strong>
                                Classes With Linked Items
                              </h2>
                            </div>
                            <div _ngcontent-oko-c377 className="body">
                              <div _ngcontent-oko-c377 className="list-group">
                                <a _ngcontent-oko-c377 className="list-group-item list-group-item-success" href="#" onclick="return false;">
                                  Dapibus ac facilisis in
                                </a>
                                <a _ngcontent-oko-c377 className="list-group-item list-group-item-info" href="#" onclick="return false;">
                                  Cras sit amet nibh libero
                                </a>
                                <a _ngcontent-oko-c377 className="list-group-item list-group-item-warning" href="#" onclick="return false;">
                                  Porta ac consectetur ac
                                </a>
                                <a _ngcontent-oko-c377 className="list-group-item list-group-item-danger" href="#" onclick="return false;">
                                  Vestibulum at eros
                                </a>
                              </div>
                            </div>
                      ...
                      <div _ngcontent-oko-c377 className="row clearfix">
                        <div _ngcontent-oko-c377 className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c377 className="card">
                            <div _ngcontent-oko-c377 className="header">
                              <h2 _ngcontent-oko-c377>
                                <strong _ngcontent-oko-c377> Colorful </strong>
                                Items With Material Design Colors
                              </h2>
                            </div>
                            <div _ngcontent-oko-c377 className="body">
                              <ul _ngcontent-oko-c377 className="list-group">
                                <li _ngcontent-oko-c377 className="list-group-item list-group-bg-pink">
                                  Dapibus ac facilisis in
                                </li>
                                <li _ngcontent-oko-c377 className="list-group-item list-group-bg-cyan">
                                  Cras sit amet nibh libero
                                </li>
                                <li _ngcontent-oko-c377 className="list-group-item list-group-bg-teal">
                                  Porta ac consectetur ac
                                </li>
                                <li _ngcontent-oko-c377 className="list-group-item list-group-bg-orange">
                                  Vestibulum at eros
                                </li>
                              </ul>
                            </div>
                        ...
                        <div _ngcontent-oko-c377 className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c377 className="card">
                            <div _ngcontent-oko-c377 className="header">
                              <h2 _ngcontent-oko-c377>
                                <strong _ngcontent-oko-c377> Custom </strong>
                                Content
                              </h2>
                            </div>
                            <div _ngcontent-oko-c377 className="body">
                              <div _ngcontent-oko-c377 className="list-group">
                                <a _ngcontent-oko-c377 className="list-group-item list-group-bg-pink" href="#" onclick="return false;">
                                  Dapibus ac facilisis in
                                </a>
                                <a _ngcontent-oko-c377 className="list-group-item list-group-bg-cyan" href="#" onclick="return false;">
                                  Cras sit amet nibh libero
                                </a>
                                <a _ngcontent-oko-c377 className="list-group-item list-group-bg-teal" href="#" onclick="return false;">
                                  Porta ac consectetur ac
                                </a>
                                <a _ngcontent-oko-c377 className="list-group-item list-group-bg-orange" href="#" onclick="return false;">
                                  Vestibulum at eros
                                </a>
                              </div>
                            </div>
                        ...
                        <div _ngcontent-oko-c377 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c377 className="card">
                            ...
                            <div _ngcontent-oko-c377 className="body">
                              <div _ngcontent-oko-c377 className="list-group">
                                <a _ngcontent-oko-c377 className="list-group-item active" href="#" onclick="return false;">
                                  <h4 _ngcontent-oko-c377 className="list-group-item-heading">
                                    List group item heading
                                  </h4>
                                  <p _ngcontent-oko-c377 className="list-group-item-text">
                                    Lorem ipsum dolor sit amet, ut duo atqui exerci
                                    dicunt, ius impedit mediocritatem an. Pri ut
                                    tation electram moderatius. Per te suavitate
                                    democritum. Duis nemore probatus ne quo, ad liber
                                    essent aliquid pro. Et eos nusquam accumsan, vide
                                    mentitum fabellas ne est, eu munere gubergren
                                    sadipscing mel.
                                  </p>
                                </a>
                                <a _ngcontent-oko-c377 className="list-group-item" href="#" onclick="return false;">
