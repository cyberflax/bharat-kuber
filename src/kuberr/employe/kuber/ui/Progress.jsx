          ...
          <app-root _nghost-oko-c137 ng-version="15.2.0">
            ...
            <app-main-layout className="ng-star-inserted">
              ...
              <div dir="ltr">
                ...
                <app-progressbars _nghost-oko-c386 className="ng-star-inserted">
                  <section _ngcontent-oko-c386 className="content">
                    <div _ngcontent-oko-c386 className="content-block">
                      <div _ngcontent-oko-c386 className="block-header">
                        <app-breadcrumb _ngcontent-oko-c386 _nghost-oko-c141>
                      ...
                      <div _ngcontent-oko-c386 className="row clearfix">
                        <div _ngcontent-oko-c386 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c386 className="card">
                            <div _ngcontent-oko-c386 className="header">
                              <h2 _ngcontent-oko-c386>
                                <strong _ngcontent-oko-c386> Basic </strong>
                                Examples
                              </h2>
                            </div>
                            <div _ngcontent-oko-c386 className="body">
                              <mat-progress-bar _ngcontent-oko-c386 aria-valuemax={100} aria-valuemin={0} aria-valuenow={40} className="mat-mdc-progress-bar mdc-linear-progress mat-primary mdc-linear-progress--animation-ready" mode="determinate" role="progressbar" tabIndex={-1} value={40}>
                      ...
                      <div _ngcontent-oko-c386 className="row clearfix">
                        <div _ngcontent-oko-c386 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c386 className="card">
                            <div _ngcontent-oko-c386 className="header">
                              <h2 _ngcontent-oko-c386>
                                <strong _ngcontent-oko-c386>
                                  Indeterminate
                                </strong>
                              </h2>
                            </div>
                            <div _ngcontent-oko-c386 className="body">
                              <mat-progress-bar _ngcontent-oko-c386 aria-valuemax={100} aria-valuemin={0} className="mat-mdc-progress-bar mdc-linear-progress mat-primary mdc-linear-progress--animation-ready mdc-linear-progress--indeterminate" mode="indeterminate" role="progressbar" tabIndex={-1}>
                                <div aria-hidden="true" className="mdc-linear-progress__buffer">
                                  <div className="mdc-linear-progress__buffer-bar" style={{"-webkit-flex-basis":"100%","-ms-flex-basis":"100%","flex-basis":"100%"}} />
                                  <div className="mdc-linear-progress__buffer-dots" />
                                </div>
                      ...
                      <div _ngcontent-oko-c386 className="row clearfix">
                        <div _ngcontent-oko-c386 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c386 className="card">
                            <div _ngcontent-oko-c386 className="header">
                              <h2 _ngcontent-oko-c386>
                                <strong _ngcontent-oko-c386> Buffer </strong>
                              </h2>
                            </div>
                            <div _ngcontent-oko-c386 className="body">
                              <mat-progress-bar _ngcontent-oko-c386 aria-valuemax={100} aria-valuemin={0} aria-valuenow={0} className="mat-mdc-progress-bar mdc-linear-progress mat-primary mdc-linear-progress--animation-ready" mode="buffer" role="progressbar" tabIndex={-1}>
                                <div aria-hidden="true" className="mdc-linear-progress__buffer">
                                  <div className="mdc-linear-progress__buffer-bar" style={{"-webkit-flex-basis":"0%","-ms-flex-basis":"0%","flex-basis":"0%"}} />
                                  <div className="mdc-linear-progress__buffer-dots" />
                                </div>
                                <div aria-hidden="true" className="mdc-linear-progress__bar mdc-linear-progress__primary-bar" style={{}}>
                                  <span className="mdc-linear-progress__bar-inner">
                      ...
                      <div _ngcontent-oko-c386 className="row clearfix">
                        <div _ngcontent-oko-c386 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c386 className="card">
                            <div _ngcontent-oko-c386 className="header">
                              <h2 _ngcontent-oko-c386>
                                <strong _ngcontent-oko-c386> Query </strong>
                              </h2>
                            </div>
                            <div _ngcontent-oko-c386 className="body">
                              <mat-progress-bar _ngcontent-oko-c386 aria-valuemax={100} aria-valuemin={0} className="mat-mdc-progress-bar mdc-linear-progress mat-warn mdc-linear-progress--animation-ready mdc-linear-progress--indeterminate" color="warn" mode="query" role="progressbar" tabIndex={-1}>
                                <div aria-hidden="true" className="mdc-linear-progress__buffer">
                                  <div className="mdc-linear-progress__buffer-bar" style={{"-webkit-flex-basis":"100%","-ms-flex-basis":"100%","flex-basis":"100%"}} />
                                  <div className="mdc-linear-progress__buffer-dots" />
                                </div>
                      ...
                      <div _ngcontent-oko-c386 className="row clearfix">
                        <div _ngcontent-oko-c386 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c386 className="card">
                            <div _ngcontent-oko-c386 className="header">
                              <h2 _ngcontent-oko-c386>
                                <strong _ngcontent-oko-c386> Bootstrap </strong>
                                Basic Progress
                              </h2>
                            </div>
                            <div _ngcontent-oko-c386 className="body">
                              <div _ngcontent-oko-c386 className="progress mb-3">
                                <div _ngcontent-oko-c386 aria-valuemax={100} aria-valuemin={0} aria-valuenow={60} className="progress-bar width-per-45" role="progressbar">
                                  <span _ngcontent-oko-c386 className="sr-only">
                                    60% Complete
                                  </span>
                                </div>
                              </div>
                              <div _ngcontent-oko-c386 className="progress">
                                <div _ngcontent-oko-c386 aria-valuemax={100} aria-valuemin={0} aria-valuenow={75} className="progress-bar width-per-75" role="progressbar">
                                  75%
                                </div>
                              </div>
                            </div>
                      ...
                      <div _ngcontent-oko-c386 className="row clearfix">
                        <div _ngcontent-oko-c386 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c386 className="card">
                            ...
                            <div _ngcontent-oko-c386 className="body">
                              <div _ngcontent-oko-c386 className="progress mb-3">
                                <div _ngcontent-oko-c386 aria-valuemax={100} aria-valuemin={0} aria-valuenow={40} className="progress-bar progress-bar-success progress-bar-striped width-per-40" role="progressbar">
                                  <span _ngcontent-oko-c386 className="sr-only">
                                    40% Complete (success)
                                  </span>
                                </div>
                              ...
                              <div _ngcontent-oko-c386 className="progress mb-3">
                                <div _ngcontent-oko-c386 aria-valuemax={100} aria-valuemin={0} aria-valuenow={20} className="progress-bar progress-bar-info progress-bar-striped width-per-20" role="progressbar">
                                  <span _ngcontent-oko-c386 className="sr-only">
                                    20% Complete
                                  </span>
                                </div>
                              ...
                              <div _ngcontent-oko-c386 className="progress mb-3">
                                <div _ngcontent-oko-c386 aria-valuemax={100} aria-valuemin={0} aria-valuenow={60} className="progress-bar progress-bar-warning progress-bar-striped width-per-60" role="progressbar">
                                  <span _ngcontent-oko-c386 className="sr-only">
                                    60% Complete (warning)
                                  </span>
                                </div>
                              ...
                              <div _ngcontent-oko-c386 className="progress mb-3">
                                <div _ngcontent-oko-c386 aria-valuemax={100} aria-valuemin={0} aria-valuenow={80} className="progress-bar progress-bar-danger progress-bar-striped width-per-80" role="progressbar">
                                  <span _ngcontent-oko-c386 className="sr-only">
                                    80% Complete (danger)
                                  </span>
                                </div>
                      ...
                      <div _ngcontent-oko-c386 className="row clearfix">
                        <div _ngcontent-oko-c386 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c386 className="card">
                            <div _ngcontent-oko-c386 className="header">
                              <h2 _ngcontent-oko-c386>
                                <strong _ngcontent-oko-c386> Stacked </strong>
                              </h2>
                            </div>
                            <div _ngcontent-oko-c386 className="body">
                              <div _ngcontent-oko-c386 className="progress">
                                <div _ngcontent-oko-c386 className="progress-bar progress-bar-success width-per-35">
                                  <span _ngcontent-oko-c386 className="sr-only">
                                    35% Complete (success)
                                  </span>
                                </div>
                                <div _ngcontent-oko-c386 className="progress-bar progress-bar-warning progress-bar-striped active width-per-20">
                                  <span _ngcontent-oko-c386 className="sr-only">
                                    20% Complete (warning)
                                  </span>
                                </div>
                                <div _ngcontent-oko-c386 className="progress-bar progress-bar-danger width-per-10">
                                  <span _ngcontent-oko-c386 className="sr-only">
                                    10% Complete (danger)
                                  </span>
                                </div>
