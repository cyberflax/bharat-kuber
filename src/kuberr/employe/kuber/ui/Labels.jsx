          ...
          <app-root _nghost-oko-c137 ng-version="15.2.0">
            ...
            <app-main-layout className="ng-star-inserted">
              ...
              <div dir="ltr">
                ...
                <app-labels _nghost-oko-c376 className="ng-star-inserted">
                  <section _ngcontent-oko-c376 className="content">
                    <div _ngcontent-oko-c376 className="content-block">
                      <div _ngcontent-oko-c376 className="block-header">
                        <app-breadcrumb _ngcontent-oko-c376 _nghost-oko-c141>
                      ...
                      <div _ngcontent-oko-c376 className="row clearfix">
                        <div _ngcontent-oko-c376 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c376 className="card">
                            <div _ngcontent-oko-c376 className="header">
                              <h2 _ngcontent-oko-c376>
                                <strong _ngcontent-oko-c376> Labels </strong>
                              </h2>
                            </div>
                            <div _ngcontent-oko-c376 className="body">
                              <span _ngcontent-oko-c376 className="label label-default">
                                Default
                              </span>
                              <span _ngcontent-oko-c376 className="label label-primary">
                                Primary
                              </span>
                              <span _ngcontent-oko-c376 className="label label-success">
                                Success
                              </span>
                              <span _ngcontent-oko-c376 className="label label-info">
                                Info
                              </span>
                              <span _ngcontent-oko-c376 className="label label-warning">
                                Warning
                              </span>
                              <span _ngcontent-oko-c376 className="label label-danger">
                                Danger
                              </span>
                              <hr _ngcontent-oko-c376 />
                              <h1 _ngcontent-oko-c376 className="m-b-20">
                                Example heading
                                <span _ngcontent-oko-c376 className="label label-danger">
                                  New
                                </span>
                              </h1>
                              <h2 _ngcontent-oko-c376 className="m-b-20">
                                Example heading
                                <span _ngcontent-oko-c376 className="label label-warning">
                                  New
                                </span>
                              </h2>
                              <h3 _ngcontent-oko-c376 className="m-b-20">
                                Example heading
                                <span _ngcontent-oko-c376 className="label label-info">
                                  New
                                </span>
                              </h3>
                              <h4 _ngcontent-oko-c376 className="m-b-20">
                                Example heading
                                <span _ngcontent-oko-c376 className="label label-success">
                                  New
                                </span>
                              </h4>
                              <h5 _ngcontent-oko-c376 className="m-b-20">
                                Example heading
                                <span _ngcontent-oko-c376 className="label label-primary">
                                  New
                                </span>
                              </h5>
                              <h6 _ngcontent-oko-c376 className="m-b-20">
                                Example heading
                                <span _ngcontent-oko-c376 className="label label-default">
                                  New
                                </span>
                      ...
                      <div _ngcontent-oko-c376 className="row clearfix">
                        <div _ngcontent-oko-c376 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c376 className="card">
                            ...
                            <div _ngcontent-oko-c376 className="body">
                              <span _ngcontent-oko-c376 className="label bg-red m-b-10">
                                Red
                              </span>
                              <span _ngcontent-oko-c376 className="label bg-pink m-b-10">
                                Pink
                              </span>
                              <span _ngcontent-oko-c376 className="label bg-purple m-b-10">
                                Purple
                              </span>
                              <span _ngcontent-oko-c376 className="label bg-indigo m-b-10">
                                Indigo
                              </span>
                              <span _ngcontent-oko-c376 className="label bg-blue m-b-10">
                                Blue
                              </span>
                              <span _ngcontent-oko-c376 className="label bg-cyan m-b-10">
                                Cyan
                              </span>
                              <span _ngcontent-oko-c376 className="label bg-teal m-b-10">
                                Teal
                              </span>
                              <span _ngcontent-oko-c376 className="label bg-green m-b-10">
                                Green
                              </span>
                              <span _ngcontent-oko-c376 className="label bg-yellow m-b-10">
                                Yellow
                              </span>
                              <span _ngcontent-oko-c376 className="label bg-orange m-b-10">
                                Orange
                              </span>
                              <span _ngcontent-oko-c376 className="label bg-black m-b-10">
                                Black
                              </span>
                            </div>
                          </div>
