          ...
          <app-root _nghost-oko-c137 ng-version="15.2.0">
            ...
            <app-main-layout className="ng-star-inserted">
              ...
              <div dir="ltr">
                ...
                <app-typography _nghost-oko-c380 className="ng-star-inserted">
                  <section _ngcontent-oko-c380 className="content">
                    <div _ngcontent-oko-c380 className="content-block">
                      <div _ngcontent-oko-c380 className="block-header">
                        <app-breadcrumb _ngcontent-oko-c380 _nghost-oko-c141>
                      ...
                      <div _ngcontent-oko-c380 className="row clearfix">
                        <div _ngcontent-oko-c380 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c380 className="card">
                            <div _ngcontent-oko-c380 className="header">
                              <h2 _ngcontent-oko-c380>
                                <strong _ngcontent-oko-c380> Heading </strong>
                              </h2>
                            </div>
                            <div _ngcontent-oko-c380 className="body">
                              <h1 _ngcontent-oko-c380>h1. MyAdmin Heading</h1>
                              <p _ngcontent-oko-c380 className="m-b-30">
                              ...
                              <h2 _ngcontent-oko-c380>h2. MyAdmin Heading</h2>
                              <p _ngcontent-oko-c380 className="m-t-10 m-b-30">
                                In enim justo, rhoncus ut, imperdiet a, venenatis
                                vitae, justo. Nullam dictum felis eu pede mollis
                                pretium. Integer tincidunt. Cras dapibus. Vivamus
                                elementum semper nisi. Aenean vulputate eleifend
                              ...
                              <h3 _ngcontent-oko-c380>h3. MyAdmin Heading</h3>
                              <p _ngcontent-oko-c380 className="m-t-15 m-b-30">
                                In enim justo, rhoncus ut, imperdiet a, venenatis
                                vitae, justo. Nullam dictum felis eu pede mollis
                                pretium. Integer tincidunt. Cras dapibus. Vivamus
                                elementum semper nisi. Aenean vulputate eleifend
                              ...
                              <h4 _ngcontent-oko-c380>h4. MyAdmin Heading</h4>
                              <p _ngcontent-oko-c380 className="m-t-15 m-b-30">
                                In enim justo, rhoncus ut, imperdiet a, venenatis
                                vitae, justo. Nullam dictum felis eu pede mollis
                                pretium. Integer tincidunt. Cras dapibus. Vivamus
                              ...
                              <h5 _ngcontent-oko-c380>h5. MyAdmin Heading</h5>
                              <p _ngcontent-oko-c380 className="m-t-15 m-b-30">
                                In enim justo, rhoncus ut, imperdiet a, venenatis
                                vitae, justo. Nullam dictum felis eu pede mollis
                                pretium. Integer tincidunt. Cras dapibus. Vivamus
                              ...
                              <h6 _ngcontent-oko-c380>h6. MyAdmin Heading</h6>
                              <p _ngcontent-oko-c380 className="m-t-15">
                                In enim justo, rhoncus ut, imperdiet a, venenatis
                                vitae, justo. Nullam dictum felis eu pede mollis
                                pretium. Integer tincidunt. Cras dapibus. Vivamus
                                elementum semper nisi. Aenean vulputate eleifend
                      ...
                      <div _ngcontent-oko-c380 className="row clearfix">
                        <div _ngcontent-oko-c380 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c380 className="card">
                            <div _ngcontent-oko-c380 className="header">
                              <h2 _ngcontent-oko-c380>
                                <strong _ngcontent-oko-c380> Text </strong>
                                Styles
                                <small _ngcontent-oko-c380>
                                  You can use classes which names are
                                  <code _ngcontent-oko-c380>
                            ...
                            <div _ngcontent-oko-c380 className="body">
                              <div _ngcontent-oko-c380 className="row clearfix">
                                <div _ngcontent-oko-c380 className="col-lg-2 col-md-2 col-sm-6 col-xs-6">
                                  <p _ngcontent-oko-c380>
                                    <b _ngcontent-oko-c380> Normal </b>
                                  </p>
                                  <p _ngcontent-oko-c380>Default text</p>
                                  <p _ngcontent-oko-c380 className="col-pink">
                                    Text pink color
                                  </p>
                                  <p _ngcontent-oko-c380 className="col-cyan">
                                    Text cyan color
                                  </p>
                                  <p _ngcontent-oko-c380 className="col-teal">
                                    Text teal color
                                  </p>
                                  <p _ngcontent-oko-c380 className="col-orange">
                                    Text orange color
                                  </p>
                                  <p _ngcontent-oko-c380 className="col-blue">
                                    Text blue grey color
                                  </p>
                                </div>
                                <div _ngcontent-oko-c380 className="col-lg-2 col-md-2 col-sm-6 col-xs-6">
                                  <p _ngcontent-oko-c380>
                                    <b _ngcontent-oko-c380> Bold </b>
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-bold">
                                    Default text
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-bold col-pink">
                                    Text pink color
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-bold col-cyan">
                                    Text cyan color
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-bold col-teal">
                                    Text teal color
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-bold col-orange">
                                    Text orange color
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-bold col-blue">
                                    Text blue grey color
                                  </p>
                                </div>
                                <div _ngcontent-oko-c380 className="col-lg-2 col-md-2 col-sm-6 col-xs-6">
                                  <p _ngcontent-oko-c380>
                                    <b _ngcontent-oko-c380> Italic </b>
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-italic">
                                    Default text
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-italic col-pink">
                                    Text pink color
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-italic col-cyan">
                                    Text cyan color
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-italic col-teal">
                                    Text teal color
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-italic col-orange">
                                    Text orange color
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-italic col-blue">
                                    Text blue grey color
                                  </p>
                                </div>
                                <div _ngcontent-oko-c380 className="col-lg-2 col-md-2 col-sm-6 col-xs-6">
                                  <p _ngcontent-oko-c380>
                                    <b _ngcontent-oko-c380> Underline </b>
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-underline">
                                    Default text
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-underline col-pink">
                                    Text pink color
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-underline col-cyan">
                                    Text cyan color
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-underline col-teal">
                                    Text teal color
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-underline col-orange">
                                    Text orange color
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-underline col-blue">
                                    Text blue grey color
                                  </p>
                                </div>
                                <div _ngcontent-oko-c380 className="col-lg-2 col-md-2 col-sm-6 col-xs-6">
                                  <p _ngcontent-oko-c380>
                                    <b _ngcontent-oko-c380> Line Through </b>
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-line-through">
                                    Default text
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-line-through col-pink">
                                    Text pink color
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-line-through col-cyan">
                                    Text cyan color
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-line-through col-teal">
                                    Text teal color
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-line-through col-orange">
                                    Text orange color
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-line-through col-blue">
                                    Text blue grey color
                                  </p>
                                </div>
                                <div _ngcontent-oko-c380 className="col-lg-2 col-md-2 col-sm-6 col-xs-6">
                                  <p _ngcontent-oko-c380>
                                    <b _ngcontent-oko-c380> Overline </b>
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-overline">
                                    Default text
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-overline col-pink">
                                    Text pink color
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-overline col-cyan">
                                    Text cyan color
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-overline col-teal">
                                    Text teal color
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-overline col-orange">
                                    Text orange color
                                  </p>
                                  <p _ngcontent-oko-c380 className="font-overline col-blue">
                                    Text blue grey color
                                  </p>
                                </div>
                              </div>
                      ...
                      <div _ngcontent-oko-c380 className="row clearfix">
                        <div _ngcontent-oko-c380 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c380 className="card">
                            <div _ngcontent-oko-c380 className="header">
                              <h2 _ngcontent-oko-c380>
                                <strong _ngcontent-oko-c380> Blockquotes </strong>
                              </h2>
                            </div>
                            <div _ngcontent-oko-c380 className="body">
                              <blockquote _ngcontent-oko-c380 className="m-b-25">
                                <p _ngcontent-oko-c380>
                                  Lorem ipsum dolor sit amet, consectetur adipiscing
                                  elit. Integer posuere erat a ante.
                                </p>
                              </blockquote>
                              <blockquote _ngcontent-oko-c380>
                                <p _ngcontent-oko-c380>
                                  Lorem ipsum dolor sit amet, consectetur adipiscing
                                  elit. Integer posuere erat a ante.
                                </p>
                                <footer _ngcontent-oko-c380>
                                  Someone famous in
                                  <cite _ngcontent-oko-c380 title="Source Title">
                                    Source Title
                                  </cite>
                                </footer>
                              </blockquote>
                              <blockquote _ngcontent-oko-c380 className="blockquote-reverse">
                                <p _ngcontent-oko-c380>
                                  Lorem ipsum dolor sit amet, consectetur adipiscing
                                  elit. Integer posuere erat a ante.
                                </p>
                      ...
                      <div _ngcontent-oko-c380 className="row clearfix">
                        <div _ngcontent-oko-c380 className="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c380 className="card">
                            <div _ngcontent-oko-c380 className="header">
                              <h2 _ngcontent-oko-c380>
                                <strong _ngcontent-oko-c380> Unordered </strong>
                                List
                              </h2>
                            </div>
                            <div _ngcontent-oko-c380 className="body">
                              <ul _ngcontent-oko-c380>
                                <li _ngcontent-oko-c380>
                                ...
                                <li _ngcontent-oko-c380>Eget porttitor lorem</li>
                              </ul>
                            </div>
                          </div>
                        </div>
                        <div _ngcontent-oko-c380 className="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c380 className="card">
                            <div _ngcontent-oko-c380 className="header">
                              <h2 _ngcontent-oko-c380>
                                <strong _ngcontent-oko-c380> Ordered </strong>
                                List
                              </h2>
                            </div>
                            <div _ngcontent-oko-c380 className="body">
                              <ol _ngcontent-oko-c380>
                                <li _ngcontent-oko-c380>
                                  Lorem ipsum dolor sit amet
                                </li>
                                <li _ngcontent-oko-c380>
                        ...
                        <div _ngcontent-oko-c380 className="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c380 className="card">
                            <div _ngcontent-oko-c380 className="header">
                              <h2 _ngcontent-oko-c380>
                                <strong _ngcontent-oko-c380> Unstyled </strong>
                                List
                              </h2>
                            </div>
                            <div _ngcontent-oko-c380 className="body">
                              <ul _ngcontent-oko-c380 className="list-unstyled">
                                <li _ngcontent-oko-c380>
                                  Lorem ipsum dolor sit amet
                                </li>
                                <li _ngcontent-oko-c380>
