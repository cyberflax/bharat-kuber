          ...
          <app-root _nghost-oko-c137 ng-version="15.2.0">
            ...
            <app-main-layout className="ng-star-inserted">
              ...
              <div dir="ltr">
                ...
                <app-cards _nghost-oko-c374 className="ng-star-inserted">
                  <section _ngcontent-oko-c374 className="content">
                    <div _ngcontent-oko-c374 className="content-block">
                      <div _ngcontent-oko-c374 className="block-header">
                        <app-breadcrumb _ngcontent-oko-c374 _nghost-oko-c141>
                      ...
                      <div _ngcontent-oko-c374 className="row">
                        <div _ngcontent-oko-c374 className="col-lg-12 col-md-12 col-sm-12 col-12">
                          <div _ngcontent-oko-c374 className="card">
                            <div _ngcontent-oko-c374 className="header">
                              <h2 _ngcontent-oko-c374>Material Card</h2>
                            </div>
                            <div _ngcontent-oko-c374 className="body">
                              <div _ngcontent-oko-c374 className="row">
                                <div _ngcontent-oko-c374 className="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                  <mat-card _ngcontent-oko-c374 className="mat-mdc-card mdc-card">
                                    <mat-card-header _ngcontent-oko-c374 className="mat-mdc-card-header">
                                      <img _ngcontent-oko-c374 className="mat-mdc-card-avatar" mat-card-avatar src="../assets/images/user/user3.jpg" />
                                      <div className="mat-mdc-card-header-text">
                                        <mat-card-title _ngcontent-oko-c374 className="mat-mdc-card-title">
                                          John Deo
                                        </mat-card-title>
                                        <mat-card-subtitle _ngcontent-oko-c374 className="mat-mdc-card-subtitle">
                                          Manager
                                        </mat-card-subtitle>
                                      </div>
                                    </mat-card-header>
                                    <img _ngcontent-oko-c374 className="mat-mdc-card-image mdc-card__media" mat-card-image src="../assets/images/image-gallery/5.jpg" />
                                    <mat-card-content _ngcontent-oko-c374 className="mat-mdc-card-content">
                                      <p _ngcontent-oko-c374>
                                    ...
                                    <mat-divider _ngcontent-oko-c374 aria-orientation="horizontal" className="mat-divider mat-divider-horizontal" role="separator">
                                    </mat-divider>
                                    <mat-card-actions _ngcontent-oko-c374 className="mat-mdc-card-actions mdc-card__actions">
                                      <div _ngcontent-oko-c374 fxlayout="row">
                                        <button _ngcontent-oko-c374 className="mdc-icon-button mat-mdc-icon-button mat-unthemed mat-mdc-button-base" mat-icon-button>
                                          <span className="mat-mdc-button-persistent-ripple mdc-icon-button__ripple">
                                          </span>
                                          <mat-icon _ngcontent-oko-c374 aria-hidden="true" className="mat-icon notranslate col-blue material-icons mat-ligature-font mat-icon-no-color" data-mat-icon-type="font" role="img">
                                            share
                                          </mat-icon>
                                        ...
                                        <button _ngcontent-oko-c374 className="mdc-icon-button mat-mdc-icon-button mat-unthemed mat-mdc-button-base" mat-icon-button>
                                          ...
                                          <mat-icon _ngcontent-oko-c374 aria-hidden="true" className="mat-icon notranslate col-red material-icons mat-ligature-font mat-icon-no-color" data-mat-icon-type="font" role="img">
                                            favorite
                                          </mat-icon>
                                          <span className="mat-mdc-focus-indicator">
                                          </span>
                                        ...
                                        <span _ngcontent-oko-c374 fxflex>
                                        </span>
                                        <button _ngcontent-oko-c374 className="mdc-button mat-mdc-button mat-unthemed mat-mdc-button-base" mat-button>
                                          <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                          </span>
                                          <span className="mdc-button__label">
                                            details
                                ...
                                <div _ngcontent-oko-c374 className="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                  <mat-card _ngcontent-oko-c374 className="mat-mdc-card mdc-card">
                                    <mat-card-header _ngcontent-oko-c374 className="mat-mdc-card-header">
                                      <img _ngcontent-oko-c374 className="mat-mdc-card-avatar" mat-card-avatar src="../assets/images/user/user1.jpg" />
                                      <div className="mat-mdc-card-header-text">
                                        <mat-card-title _ngcontent-oko-c374 className="mat-mdc-card-title">
                                          John Deo
                                        </mat-card-title>
                                    ...
                                    <img _ngcontent-oko-c374 className="mat-mdc-card-image mdc-card__media" mat-card-image src="../assets/images/image-gallery/7.jpg" />
                                    <mat-card-content _ngcontent-oko-c374 className="mat-mdc-card-content">
                                      <p _ngcontent-oko-c374>
                                        The Shiba Inu is the smallest of the six
                                        original and distinct spitz breeds of dog from
                                ...
                                <div _ngcontent-oko-c374 className="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                  <mat-card _ngcontent-oko-c374 className="mat-mdc-card mdc-card">
                                    <mat-card-header _ngcontent-oko-c374 className="mat-mdc-card-header">
                                      <img _ngcontent-oko-c374 className="mat-mdc-card-avatar" mat-card-avatar src="../assets/images/user/user2.jpg" />
                                      <div className="mat-mdc-card-header-text">
                                        <mat-card-title _ngcontent-oko-c374 className="mat-mdc-card-title">
                                          Airi Satou
                                        </mat-card-title>
                                    ...
                                    <img _ngcontent-oko-c374 className="mat-mdc-card-image mdc-card__media" mat-card-image src="../assets/images/image-gallery/2.jpg" />
                                    <mat-card-content _ngcontent-oko-c374 className="mat-mdc-card-content">
                                      <p _ngcontent-oko-c374>
                                        The Shiba Inu is the smallest of the six
                                        original and distinct spitz breeds of dog from
