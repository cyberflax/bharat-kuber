          ...
          <app-root _nghost-oko-c137 ng-version="15.2.0">
            ...
            <app-main-layout className="ng-star-inserted">
              ...
              <div dir="ltr">
                ...
                <app-snackbar _nghost-oko-c398 className="ng-star-inserted">
                  <section _ngcontent-oko-c398 className="content">
                    <div _ngcontent-oko-c398 className="content-block">
                      <div _ngcontent-oko-c398 className="block-header">
                        <app-breadcrumb _ngcontent-oko-c398 _nghost-oko-c141>
                      ...
                      <div _ngcontent-oko-c398 className="row clearfix">
                        <div _ngcontent-oko-c398 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c398 className="card">
                            <div _ngcontent-oko-c398 className="header">
                              <h2 _ngcontent-oko-c398>
                                <strong _ngcontent-oko-c398> Notification </strong>
                                Positions
                              </h2>
                            </div>
                            <div _ngcontent-oko-c398 className="body">
                              <div _ngcontent-oko-c398 className="row clearfix jsdemo-notification-button">
                                <div _ngcontent-oko-c398 className="col-xs-12 col-sm-6 col-md-3 col-lg-2">
                                  <button _ngcontent-oko-c398 className="mdc-button mdc-button--raised mat-mdc-raised-button mat-primary mat-mdc-button-base" color="primary" mat-raised-button>
                                    <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                    </span>
                                    <span className="mdc-button__label"> Top Left </span>
                                    <span className="mat-mdc-focus-indicator"> </span>
                                    <span className="mat-ripple mat-mdc-button-ripple" matripple>
                                    </span>
                                    <span className="mat-mdc-button-touch-target"> </span>
                                ...
                                <div _ngcontent-oko-c398 className="col-xs-12 col-sm-6 col-md-3 col-lg-2">
                                  <button _ngcontent-oko-c398 className="mdc-button mdc-button--raised mat-mdc-raised-button mat-accent mat-mdc-button-base" color="accent" mat-raised-button>
                                    <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                    </span>
                                    <span className="mdc-button__label">
                                      Bottom Left
                                ...
                                <div _ngcontent-oko-c398 className="col-xs-12 col-sm-6 col-md-3 col-lg-2">
                                  <button _ngcontent-oko-c398 className="mdc-button mdc-button--raised mat-mdc-raised-button mat-warn mat-mdc-button-base" color="warn" mat-raised-button>
                                    <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                    </span>
                                    <span className="mdc-button__label">
                                      Bottom Center
                                ...
                                <div _ngcontent-oko-c398 className="col-xs-12 col-sm-6 col-md-3 col-lg-2">
                                  <button _ngcontent-oko-c398 className="bg-green mdc-button mdc-button--raised mat-mdc-raised-button mat-unthemed mat-mdc-button-base" mat-raised-button>
                                    <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                    </span>
                                    <span className="mdc-button__label">
                                      Bottom Right
                                ...
                                <div _ngcontent-oko-c398 className="col-xs-12 col-sm-6 col-md-3 col-lg-2">
                                  <button _ngcontent-oko-c398 className="bg-cyan mdc-button mdc-button--raised mat-mdc-raised-button mat-unthemed mat-mdc-button-base" mat-raised-button>
                                    <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                    </span>
                                    <span className="mdc-button__label"> Top Right </span>
                                    <span className="mat-mdc-focus-indicator"> </span>
                                    <span className="mat-ripple mat-mdc-button-ripple" matripple>
                                    </span>
                                    <span className="mat-mdc-button-touch-target"> </span>
                                ...
                                <div _ngcontent-oko-c398 className="col-xs-12 col-sm-6 col-md-3 col-lg-2">
                                  <button _ngcontent-oko-c398 className="bg-blue mdc-button mdc-button--raised mat-mdc-raised-button mat-unthemed mat-mdc-button-base" mat-raised-button>
                                    <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                    </span>
                                    <span className="mdc-button__label">
                                      Top Center
                              ...
                              <div _ngcontent-oko-c398 className="row clearfix jsdemo-notification-button">
                                <div _ngcontent-oko-c398 className="col-xs-12 col-sm-6 col-md-3 col-lg-2">
                                  <button _ngcontent-oko-c398 className="bg-green mdc-button mdc-button--raised mat-mdc-raised-button mat-unthemed mat-mdc-button-base" mat-raised-button>
                                    ...
                                    <span className="mdc-button__label"> Success </span>
                                    <span className="mat-mdc-focus-indicator"> </span>
                                    <span className="mat-ripple mat-mdc-button-ripple" matripple>
                                    </span>
                                    <span className="mat-mdc-button-touch-target"> </span>
                                ...
                                <div _ngcontent-oko-c398 className="col-xs-12 col-sm-6 col-md-3 col-lg-2">
                                  <button _ngcontent-oko-c398 className="bg-red mdc-button mdc-button--raised mat-mdc-raised-button mat-unthemed mat-mdc-button-base" mat-raised-button>
                                    <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                    </span>
                                    <span className="mdc-button__label"> Danger </span>
                                    <span className="mat-mdc-focus-indicator"> </span>
                                    <span className="mat-ripple mat-mdc-button-ripple" matripple>
                                    </span>
                                    <span className="mat-mdc-button-touch-target"> </span>
                                ...
                                <div _ngcontent-oko-c398 className="col-xs-12 col-sm-6 col-md-3 col-lg-2">
                                  <button _ngcontent-oko-c398 className="bg-yellow mdc-button mdc-button--raised mat-mdc-raised-button mat-unthemed mat-mdc-button-base" mat-raised-button>
                                    <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                    </span>
                                    <span className="mdc-button__label"> Warning </span>
                                    <span className="mat-mdc-focus-indicator"> </span>
                                    <span className="mat-ripple mat-mdc-button-ripple" matripple>
                                    </span>
                                    <span className="mat-mdc-button-touch-target"> </span>
                                ...
                                <div _ngcontent-oko-c398 className="col-xs-12 col-sm-6 col-md-3 col-lg-2">
                                  <button _ngcontent-oko-c398 className="bg-cyan mdc-button mdc-button--raised mat-mdc-raised-button mat-unthemed mat-mdc-button-base" mat-raised-button>
                                    ...
                                    <span className="mdc-button__label"> Info </span>
                                    <span className="mat-mdc-focus-indicator"> </span>
                                    <span className="mat-ripple mat-mdc-button-ripple" matripple>
                                    </span>
                                    <span className="mat-mdc-button-touch-target"> </span>
