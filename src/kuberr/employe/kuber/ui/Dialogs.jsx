          ...
          <app-root _nghost-oko-c137 ng-version="15.2.0">
            ...
            <app-main-layout className="ng-star-inserted">
              ...
              <div dir="ltr">
                ...
                <app-dialogs _nghost-oko-c375 className="ng-star-inserted">
                  <section _ngcontent-oko-c375 className="content">
                    <div _ngcontent-oko-c375 className="content-block">
                      <div _ngcontent-oko-c375 className="block-header">
                        <app-breadcrumb _ngcontent-oko-c375 _nghost-oko-c141>
                      ...
                      <div _ngcontent-oko-c375 className="row">
                        <div _ngcontent-oko-c375 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c375 className="card">
                            <div _ngcontent-oko-c375 className="header">
                              <h2 _ngcontent-oko-c375>
                                <strong _ngcontent-oko-c375> Examples </strong>
                              </h2>
                            </div>
                            <div _ngcontent-oko-c375 className="body">
                              <div _ngcontent-oko-c375 className="row clearfix js-sweetalert">
                                <div _ngcontent-oko-c375 className="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                  <p _ngcontent-oko-c375>A basic message</p>
                                  <button _ngcontent-oko-c375 className="mdc-button mdc-button--raised mat-mdc-raised-button mat-primary mat-mdc-button-base" color="primary" mat-raised-button>
                                    <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                    </span>
                                    <span className="mdc-button__label"> CLICK ME </span>
                                    <span className="mat-mdc-focus-indicator"> </span>
                                    <span className="mat-ripple mat-mdc-button-ripple" matripple>
                                    </span>
                                    <span className="mat-mdc-button-touch-target"> </span>
                                ...
                                <div _ngcontent-oko-c375 className="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                  <p _ngcontent-oko-c375>
                                    Custom HTML description and buttons with ARIA
                                    labels
                                  </p>
                                  <button _ngcontent-oko-c375 className="mdc-button mdc-button--raised mat-mdc-raised-button mat-primary mat-mdc-button-base" color="primary" mat-raised-button>
                                    <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                ...
                                <div _ngcontent-oko-c375 className="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                  <p _ngcontent-oko-c375>
                                    passing a parameter, you can execute something
                                    else for "Cancel".
                                  </p>
                                  <button _ngcontent-oko-c375 className="mdc-button mdc-button--raised mat-mdc-raised-button mat-primary mat-mdc-button-base" color="primary" mat-raised-button>
                                    <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                ...
                                <div _ngcontent-oko-c375 className="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                  <p _ngcontent-oko-c375>
                                    Right-to-left support for Arabic, Persian, Hebrew,
                                ...
                                <div _ngcontent-oko-c375 className="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                  <p _ngcontent-oko-c375>AJAX request example</p>
                                  <button _ngcontent-oko-c375 className="mdc-button mdc-button--raised mat-mdc-raised-button mat-primary mat-mdc-button-base" color="primary" mat-raised-button>
                                    <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                    </span>
                                    <span className="mdc-button__label"> CLICK ME </span>
