          ...
          <app-root _nghost-oko-c137 ng-version="15.2.0">
            ...
            <app-main-layout className="ng-star-inserted">
              ...
              <div dir="ltr">
                ...
                <app-buttons _nghost-oko-c385 className="ng-star-inserted">
                  <section _ngcontent-oko-c385 className="content">
                    <div _ngcontent-oko-c385 className="content-block">
                      <div _ngcontent-oko-c385 className="block-header">
                        <app-breadcrumb _ngcontent-oko-c385 _nghost-oko-c141>
                      ...
                      <div _ngcontent-oko-c385 className="row">
                        <div _ngcontent-oko-c385 className="col-lg-12 col-md-12 col-sm-12 col-12">
                          <div _ngcontent-oko-c385 className="card">
                            <div _ngcontent-oko-c385 className="header">
                              <h2 _ngcontent-oko-c385>Basic Buttons</h2>
                            </div>
                            <div _ngcontent-oko-c385 className="body">
                              <div _ngcontent-oko-c385 className="example-button-row">
                                <button _ngcontent-oko-c385 className="basic-btn mdc-button mat-mdc-button mat-unthemed mat-mdc-button-base" mat-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Basic </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                  <span className="mat-ripple mat-mdc-button-ripple" matripple>
                                  </span>
                                  <span className="mat-mdc-button-touch-target"> </span>
                                </button>
                                <button _ngcontent-oko-c385 className="mdc-button mat-mdc-button mat-primary mat-mdc-button-base" color="primary" mat-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Primary </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                  <span className="mat-ripple mat-mdc-button-ripple" matripple>
                                  </span>
                                  <span className="mat-mdc-button-touch-target"> </span>
                                </button>
                                <button _ngcontent-oko-c385 className="mdc-button mat-mdc-button mat-accent mat-mdc-button-base" color="accent" mat-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Accent </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                  <span className="mat-ripple mat-mdc-button-ripple" matripple>
                                  </span>
                                  <span className="mat-mdc-button-touch-target"> </span>
                                </button>
                                <button _ngcontent-oko-c385 className="mdc-button mat-mdc-button mat-warn mat-mdc-button-base" color="warn" mat-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Warn </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                  <span className="mat-ripple mat-mdc-button-ripple" matripple>
                                  </span>
                                  <span className="mat-mdc-button-touch-target"> </span>
                                </button>
                                <button _ngcontent-oko-c385 className="basic-btn-disabled mdc-button mat-mdc-button mat-unthemed mat-mdc-button-base" disabled="true" mat-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Disabled </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                  <span className="mat-ripple mat-mdc-button-ripple" matripple>
                                  </span>
                                  <span className="mat-mdc-button-touch-target"> </span>
                                </button>
                                <a _ngcontent-oko-c385 aria-disabled="false" className="basic-btn-link mdc-button mat-mdc-button mat-unthemed mat-mdc-button-base" href="#/ui/buttons" mat-button routerlink=".">
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Link </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                  <span className="mat-ripple mat-mdc-button-ripple" matripple>
                                  </span>
                                  <span className="mat-mdc-button-touch-target"> </span>
                      ...
                      <div _ngcontent-oko-c385 className="row">
                        <div _ngcontent-oko-c385 className="col-lg-12 col-md-12 col-sm-12 col-12">
                          <div _ngcontent-oko-c385 className="card">
                            <div _ngcontent-oko-c385 className="header">
                              <h2 _ngcontent-oko-c385>Raised Buttons</h2>
                            </div>
                            <div _ngcontent-oko-c385 className="body">
                              <div _ngcontent-oko-c385 className="example-button-row">
                                <button _ngcontent-oko-c385 className="mdc-button mdc-button--raised mat-mdc-raised-button mat-unthemed mat-mdc-button-base" mat-raised-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Basic </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <button _ngcontent-oko-c385 className="mdc-button mdc-button--raised mat-mdc-raised-button mat-primary mat-mdc-button-base" color="primary" mat-raised-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Primary </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <button _ngcontent-oko-c385 className="mdc-button mdc-button--raised mat-mdc-raised-button mat-accent mat-mdc-button-base" color="accent" mat-raised-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Accent </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <button _ngcontent-oko-c385 className="mdc-button mdc-button--raised mat-mdc-raised-button mat-warn mat-mdc-button-base" color="warn" mat-raised-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Warn </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <button _ngcontent-oko-c385 className="mdc-button mdc-button--raised mat-mdc-raised-button mat-unthemed mat-mdc-button-base" disabled="true" mat-raised-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Disabled </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <a _ngcontent-oko-c385 aria-disabled="false" className="mdc-button mdc-button--raised mat-mdc-raised-button mat-unthemed mat-mdc-button-base" href="#/ui/buttons" mat-raised-button routerlink=".">
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Link </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                      ...
                      <div _ngcontent-oko-c385 className="row">
                        <div _ngcontent-oko-c385 className="col-lg-12 col-md-12 col-sm-12 col-12">
                          <div _ngcontent-oko-c385 className="card">
                            <div _ngcontent-oko-c385 className="header">
                              <h2 _ngcontent-oko-c385>Stroked Buttons</h2>
                            </div>
                            <div _ngcontent-oko-c385 className="body">
                              <div _ngcontent-oko-c385 className="example-button-row">
                                <button _ngcontent-oko-c385 className="stroked-btn mdc-button mdc-button--outlined mat-mdc-outlined-button mat-unthemed mat-mdc-button-base" mat-stroked-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Basic </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <button _ngcontent-oko-c385 className="mdc-button mdc-button--outlined mat-mdc-outlined-button mat-primary mat-mdc-button-base" color="primary" mat-stroked-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Primary </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <button _ngcontent-oko-c385 className="mdc-button mdc-button--outlined mat-mdc-outlined-button mat-accent mat-mdc-button-base" color="accent" mat-stroked-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Accent </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <button _ngcontent-oko-c385 className="mdc-button mdc-button--outlined mat-mdc-outlined-button mat-warn mat-mdc-button-base" color="warn" mat-stroked-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Warn </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <button _ngcontent-oko-c385 className="stroked-btn-disabled mdc-button mdc-button--outlined mat-mdc-outlined-button mat-unthemed mat-mdc-button-base" disabled="true" mat-stroked-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Disabled </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <a _ngcontent-oko-c385 aria-disabled="false" className="stroked-btn-link mdc-button mdc-button--outlined mat-mdc-outlined-button mat-unthemed mat-mdc-button-base" href="#/ui/buttons" mat-stroked-button routerlink=".">
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Link </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                      ...
                      <div _ngcontent-oko-c385 className="row">
                        <div _ngcontent-oko-c385 className="col-lg-12 col-md-12 col-sm-12 col-12">
                          <div _ngcontent-oko-c385 className="card">
                            <div _ngcontent-oko-c385 className="header">
                              <h2 _ngcontent-oko-c385>Flat Buttons</h2>
                            </div>
                            <div _ngcontent-oko-c385 className="body">
                              <div _ngcontent-oko-c385 className="example-button-row">
                                <button _ngcontent-oko-c385 className="mdc-button mdc-button--unelevated mat-mdc-unelevated-button mat-unthemed mat-mdc-button-base" mat-flat-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Basic </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <button _ngcontent-oko-c385 className="mdc-button mdc-button--unelevated mat-mdc-unelevated-button mat-primary mat-mdc-button-base" color="primary" mat-flat-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Primary </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <button _ngcontent-oko-c385 className="mdc-button mdc-button--unelevated mat-mdc-unelevated-button mat-accent mat-mdc-button-base" color="accent" mat-flat-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Accent </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <button _ngcontent-oko-c385 className="mdc-button mdc-button--unelevated mat-mdc-unelevated-button mat-warn mat-mdc-button-base" color="warn" mat-flat-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Warn </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <button _ngcontent-oko-c385 className="flat-btn-disabled mdc-button mdc-button--unelevated mat-mdc-unelevated-button mat-unthemed mat-mdc-button-base" disabled="true" mat-flat-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Disabled </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <a _ngcontent-oko-c385 aria-disabled="false" className="mdc-button mdc-button--unelevated mat-mdc-unelevated-button mat-unthemed mat-mdc-button-base" href="#/ui/buttons" mat-flat-button routerlink=".">
                                  <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Link </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                      ...
                      <div _ngcontent-oko-c385 className="row">
                        <div _ngcontent-oko-c385 className="col-lg-12 col-md-12 col-sm-12 col-12">
                          <div _ngcontent-oko-c385 className="card">
                            <div _ngcontent-oko-c385 className="header">
                              <h2 _ngcontent-oko-c385>Icon Buttons</h2>
                            </div>
                            <div _ngcontent-oko-c385 className="body">
                              <div _ngcontent-oko-c385 className="example-button-row">
                                <button _ngcontent-oko-c385 aria-label="Example icon-button with a heart icon" className="mdc-icon-button mat-mdc-icon-button mat-unthemed mat-mdc-button-base" mat-icon-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-icon-button__ripple">
                                  </span>
                                  <mat-icon _ngcontent-oko-c385 aria-hidden="true" className="mat-icon notranslate material-icons mat-ligature-font mat-icon-no-color" data-mat-icon-type="font" role="img">
                                    favorite
                                  </mat-icon>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                  <span className="mat-ripple mat-mdc-button-ripple" matripple>
                                ...
                                <button _ngcontent-oko-c385 aria-label="Example icon-button with a heart icon" className="mdc-icon-button mat-mdc-icon-button mat-primary mat-mdc-button-base" color="primary" mat-icon-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-icon-button__ripple">
                                  </span>
                                  <mat-icon _ngcontent-oko-c385 aria-hidden="true" className="mat-icon notranslate material-icons mat-ligature-font mat-icon-no-color" data-mat-icon-type="font" role="img">
                                    favorite
                                ...
                                <button _ngcontent-oko-c385 aria-label="Example icon-button with a heart icon" className="mdc-icon-button mat-mdc-icon-button mat-accent mat-mdc-button-base" color="accent" mat-icon-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-icon-button__ripple">
                                  </span>
                                  <mat-icon _ngcontent-oko-c385 aria-hidden="true" className="mat-icon notranslate material-icons mat-ligature-font mat-icon-no-color" data-mat-icon-type="font" role="img">
                                    favorite
                                ...
                                <button _ngcontent-oko-c385 aria-label="Example icon-button with a heart icon" className="mdc-icon-button mat-mdc-icon-button mat-warn mat-mdc-button-base" color="warn" mat-icon-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-icon-button__ripple">
                                  </span>
                                  <mat-icon _ngcontent-oko-c385 aria-hidden="true" className="mat-icon notranslate material-icons mat-ligature-font mat-icon-no-color" data-mat-icon-type="font" role="img">
                                    favorite
                                ...
                                <button _ngcontent-oko-c385 aria-label="Example icon-button with a heart icon" className="mdc-icon-button mat-mdc-icon-button mat-unthemed mat-mdc-button-base" disabled="true" mat-icon-button>
                                  <span className="mat-mdc-button-persistent-ripple mdc-icon-button__ripple">
                                  </span>
                                  <mat-icon _ngcontent-oko-c385 aria-hidden="true" className="mat-icon notranslate material-icons mat-ligature-font mat-icon-no-color" data-mat-icon-type="font" role="img">
                                    favorite
                      ...
                      <div _ngcontent-oko-c385 className="row">
                        <div _ngcontent-oko-c385 className="col-lg-12 col-md-12 col-sm-12 col-12">
                          <div _ngcontent-oko-c385 className="card">
                            <div _ngcontent-oko-c385 className="header">
                              <h2 _ngcontent-oko-c385>Fab Buttons</h2>
                            </div>
                            <div _ngcontent-oko-c385 className="body">
                              <div _ngcontent-oko-c385 className="example-button-row">
                                <button _ngcontent-oko-c385 className="mdc-fab mat-mdc-fab mat-accent mat-mdc-button-base" mat-fab>
                                ...
                                <button _ngcontent-oko-c385 className="mdc-fab mat-mdc-fab mat-primary mat-mdc-button-base" color="primary" mat-fab>
                                  <span className="mat-mdc-button-persistent-ripple mdc-fab__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Primary </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <button _ngcontent-oko-c385 className="mdc-fab mat-mdc-fab mat-accent mat-mdc-button-base" color="accent" mat-fab>
                                  <span className="mat-mdc-button-persistent-ripple mdc-fab__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Accent </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <button _ngcontent-oko-c385 className="mdc-fab mat-mdc-fab mat-warn mat-mdc-button-base" color="warn" mat-fab>
                                  <span className="mat-mdc-button-persistent-ripple mdc-fab__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Warn </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <button _ngcontent-oko-c385 className="fab-btn-disabled mdc-fab mat-mdc-fab mat-accent mat-mdc-button-base" disabled="true" mat-fab>
                                  <span className="mat-mdc-button-persistent-ripple mdc-fab__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Disabled </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <button _ngcontent-oko-c385 aria-label="Example icon-button with a heart icon" className="mdc-fab mat-mdc-fab mat-accent mat-mdc-button-base" mat-fab>
                                  <span className="mat-mdc-button-persistent-ripple mdc-fab__ripple">
                                  </span>
                                  <mat-icon _ngcontent-oko-c385 aria-hidden="true" className="mat-icon notranslate material-icons mat-ligature-font mat-icon-no-color" data-mat-icon-type="font" role="img">
                                    favorite
                                ...
                                <a _ngcontent-oko-c385 aria-disabled="false" className="mdc-fab mat-mdc-fab mat-accent mat-mdc-button-base" href="#/ui/buttons" mat-fab routerlink=".">
                                  <span className="mat-mdc-button-persistent-ripple mdc-fab__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Link </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                      ...
                      <div _ngcontent-oko-c385 className="row">
                        <div _ngcontent-oko-c385 className="col-lg-12 col-md-12 col-sm-12 col-12">
                          <div _ngcontent-oko-c385 className="card">
                            <div _ngcontent-oko-c385 className="header">
                              <h2 _ngcontent-oko-c385>Mini Fab Buttons</h2>
                            </div>
                            <div _ngcontent-oko-c385 className="body">
                              <div _ngcontent-oko-c385 className="example-button-row">
                                <button _ngcontent-oko-c385 className="mdc-fab mdc-fab--mini mat-mdc-mini-fab mat-accent mat-mdc-button-base" mat-mini-fab>
                                  <span className="mat-mdc-button-persistent-ripple mdc-fab__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Basic </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <button _ngcontent-oko-c385 className="mdc-fab mdc-fab--mini mat-mdc-mini-fab mat-primary mat-mdc-button-base" color="primary" mat-mini-fab>
                                  <span className="mat-mdc-button-persistent-ripple mdc-fab__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Primary </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <button _ngcontent-oko-c385 className="mdc-fab mdc-fab--mini mat-mdc-mini-fab mat-accent mat-mdc-button-base" color="accent" mat-mini-fab>
                                  <span className="mat-mdc-button-persistent-ripple mdc-fab__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Accent </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <button _ngcontent-oko-c385 className="mdc-fab mdc-fab--mini mat-mdc-mini-fab mat-warn mat-mdc-button-base" color="warn" mat-mini-fab>
                                  <span className="mat-mdc-button-persistent-ripple mdc-fab__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Warn </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <button _ngcontent-oko-c385 className="mini-fab-btn-disabled mdc-fab mdc-fab--mini mat-mdc-mini-fab mat-accent mat-mdc-button-base" disabled="true" mat-mini-fab>
                                  <span className="mat-mdc-button-persistent-ripple mdc-fab__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Disabled </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                ...
                                <button _ngcontent-oko-c385 aria-label="Example icon-button with a heart icon" className="mdc-fab mdc-fab--mini mat-mdc-mini-fab mat-accent mat-mdc-button-base" mat-mini-fab>
                                  <span className="mat-mdc-button-persistent-ripple mdc-fab__ripple">
                                  </span>
                                  <mat-icon _ngcontent-oko-c385 aria-hidden="true" className="mat-icon notranslate material-icons mat-ligature-font mat-icon-no-color" data-mat-icon-type="font" role="img">
                                    favorite
                                ...
                                <a _ngcontent-oko-c385 aria-disabled="false" className="mdc-fab mdc-fab--mini mat-mdc-mini-fab mat-accent mat-mdc-button-base" href="#/ui/buttons" mat-mini-fab routerlink=".">
                                  <span className="mat-mdc-button-persistent-ripple mdc-fab__ripple">
                                  </span>
                                  <span className="mdc-button__label"> Link </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                      ...
                      <div _ngcontent-oko-c385 className="row">
                        <div _ngcontent-oko-c385 className="col-lg-12 col-md-12 col-sm-12 col-12">
                          <div _ngcontent-oko-c385 className="card">
                            <div _ngcontent-oko-c385 className="header">
                              <h2 _ngcontent-oko-c385>Outline Buttons</h2>
                            </div>
                            <div _ngcontent-oko-c385 className="body">
                              <div _ngcontent-oko-c385 className="button-demo">
                                <button _ngcontent-oko-c385 className="btn btn-outline-default" type="button">
                                  Default
                                </button>
                                <button _ngcontent-oko-c385 className="btn btn-outline-primary" type="button">
                                  Primary
                                </button>
                                <button _ngcontent-oko-c385 className="btn btn-outline-success" type="button">
                                  Success
                                </button>
                                <button _ngcontent-oko-c385 className="btn btn-outline-info" type="button">
                                  Info
                                </button>
                                <button _ngcontent-oko-c385 className="btn btn-outline-warning" type="button">
                                  Warning
                                </button>
                                <button _ngcontent-oko-c385 className="btn btn-outline-danger" type="button">
                                  Danger
                                </button>
                              </div>
                            </div>
