          ...
          <app-root _nghost-oko-c137 ng-version="15.2.0">
            ...
            <app-main-layout className="ng-star-inserted">
              ...
              <div dir="ltr">
                ...
                <app-alerts _nghost-oko-c382 className="ng-star-inserted">
                  <section _ngcontent-oko-c382 className="content">
                    <div _ngcontent-oko-c382 className="content-block">
                      <div _ngcontent-oko-c382 className="block-header">
                        <app-breadcrumb _ngcontent-oko-c382 _nghost-oko-c141>
                      ...
                      <div _ngcontent-oko-c382 className="row clearfix">
                        <div _ngcontent-oko-c382 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c382 className="card">
                            <div _ngcontent-oko-c382 className="header">
                              <h2 _ngcontent-oko-c382>
                                <strong _ngcontent-oko-c382> Basic </strong>
                                Alert
                              </h2>
                            </div>
                            <div _ngcontent-oko-c382 className="body">
                              <div _ngcontent-oko-c382 className="alert alert-success">
                                <strong _ngcontent-oko-c382> Well done! </strong>
                                You successfully read this important alert message.
                              </div>
                              <div _ngcontent-oko-c382 className="alert alert-info">
                                <strong _ngcontent-oko-c382> Heads up! </strong>
                                This alert needs your attention, but it's not super
                                important.
                              </div>
                              <div _ngcontent-oko-c382 className="alert alert-warning">
                                <strong _ngcontent-oko-c382> Warning! </strong>
                                Better check yourself, you're not looking too good.
                              </div>
                              <div _ngcontent-oko-c382 className="alert alert-danger">
                                <strong _ngcontent-oko-c382> Oh snap! </strong>
                      ...
                      <div _ngcontent-oko-c382 className="row clearfix">
                        <div _ngcontent-oko-c382 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c382 className="card">
                            <div _ngcontent-oko-c382 className="header">
                              <h2 _ngcontent-oko-c382>
                                <strong _ngcontent-oko-c382> Links </strong>
                                In Alert
                              </h2>
                            </div>
                            <div _ngcontent-oko-c382 className="body">
                              <div _ngcontent-oko-c382 className="alert alert-success">
                                ...
                                <a _ngcontent-oko-c382 className="alert-link" href="#" onclick="return false;">
                              ...
                              <div _ngcontent-oko-c382 className="alert bg-pink">
                                Lorem ipsum dolor sit amet, id fugit tollit pro, illud
                                nostrud aliquando ad est, quo esse dolorum id
                                <a _ngcontent-oko-c382 className="alert-link" href="#" onclick="return false;">
                                  alert link
                                </a>
                                .
