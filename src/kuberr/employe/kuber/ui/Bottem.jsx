          ...
          <app-root _nghost-oko-c137 ng-version="15.2.0">
            ...
            <app-main-layout className="ng-star-inserted">
              ...
              <div dir="ltr">
                ...
                <app-bottom-sheet _nghost-oko-c396 className="ng-star-inserted">
                  <section _ngcontent-oko-c396 className="content">
                    <div _ngcontent-oko-c396 className="content-block">
                      <div _ngcontent-oko-c396 className="block-header">
                        <app-breadcrumb _ngcontent-oko-c396 _nghost-oko-c141>
                      ...
                      <div _ngcontent-oko-c396 className="row">
                        <div _ngcontent-oko-c396 className="col-lg-12 col-md-12 col-sm-12 col-12">
                          <div _ngcontent-oko-c396 className="card">
                            <div _ngcontent-oko-c396 className="header">
                              <h2 _ngcontent-oko-c396>Bottom Sheet Overview</h2>
                            </div>
                            <div _ngcontent-oko-c396 className="body">
                              <p _ngcontent-oko-c396>
                                You have received a file called "cat-picture.jpeg".
                              </p>
                              <button _ngcontent-oko-c396 className="mdc-button mdc-button--raised mat-mdc-raised-button mat-unthemed mat-mdc-button-base" mat-raised-button>
                                <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                </span>
                                <span className="mdc-button__label"> Open file </span>
                                <span className="mat-mdc-focus-indicator"> </span>
                                <span className="mat-ripple mat-mdc-button-ripple" matripple>
                                </span>
                                <span className="mat-mdc-button-touch-target"> </span>
