          ...
          <app-root _nghost-oko-c137 ng-version="15.2.0">
            ...
            <app-main-layout className="ng-star-inserted">
              ...
              <div dir="ltr">
                ...
                <app-modal _nghost-oko-c389 className="ng-star-inserted">
                  <section _ngcontent-oko-c389 className="content">
                    <div _ngcontent-oko-c389 className="content-block">
                      <div _ngcontent-oko-c389 className="block-header">
                        <app-breadcrumb _ngcontent-oko-c389 _nghost-oko-c141>
                      ...
                      <div _ngcontent-oko-c389 className="row">
                        <div _ngcontent-oko-c389 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c389 className="card">
                            <div _ngcontent-oko-c389 className="header">
                              <h2 _ngcontent-oko-c389>Simple Modal Dialog</h2>
                            </div>
                            <div _ngcontent-oko-c389 className="body">
                              <h6 _ngcontent-oko-c389>
                                Simple Dialog With Action Button
                              </h6>
                              <br _ngcontent-oko-c389 />
                              <button _ngcontent-oko-c389 className="mdc-button mdc-button--raised mat-mdc-raised-button mat-primary mat-mdc-button-base" color="primary" mat-raised-button>
                                <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                </span>
                                <span className="mdc-button__label">
                      ...
                      <div _ngcontent-oko-c389 className="row">
                        <div _ngcontent-oko-c389 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c389 className="card">
                            <div _ngcontent-oko-c389 className="header">
                              <h2 _ngcontent-oko-c389>Dialog With Form</h2>
                            </div>
                            <div _ngcontent-oko-c389 className="body">
                              <div _ngcontent-oko-c389>
                                <h6 _ngcontent-oko-c389>
                                ...
                                <button _ngcontent-oko-c389 className="mdc-button mdc-button--raised mat-mdc-raised-button mat-primary mat-mdc-button-base" color="primary" mat-raised-button>
                                  ...
                                  <span className="mdc-button__label"> Click Here </span>
                                  <span className="mat-mdc-focus-indicator"> </span>
                                  <span className="mat-ripple mat-mdc-button-ripple" matripple>
                                  </span>
                                  <span className="mat-mdc-button-touch-target"> </span>
