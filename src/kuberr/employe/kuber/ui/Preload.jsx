          ...
          <app-root _nghost-oko-c137 ng-version="15.2.0">
            ...
            <app-main-layout className="ng-star-inserted">
              ...
              <div dir="ltr">
                ...
                <app-preloaders _nghost-oko-c378 className="ng-star-inserted">
                  <section _ngcontent-oko-c378 className="content">
                    <div _ngcontent-oko-c378 className="content-block">
                      <div _ngcontent-oko-c378 className="block-header">
                        <app-breadcrumb _ngcontent-oko-c378 _nghost-oko-c141>
                      ...
                      <div _ngcontent-oko-c378 className="row clearfix">
                        <div _ngcontent-oko-c378 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c378 className="card">
                            <div _ngcontent-oko-c378 className="header">
                              <h2 _ngcontent-oko-c378>Material Preloaders</h2>
                            </div>
                            <div _ngcontent-oko-c378 className="body">
                              <mat-spinner _ngcontent-oko-c378 aria-valuemax={100} aria-valuemin={0} className="mat-mdc-progress-spinner mdc-circular-progress mat-primary mdc-circular-progress--indeterminate" mode="indeterminate" role="progressbar" style={{"width":"100px","height":"100px"}} tabIndex={-1}>
                                {/* */}
                                <div aria-hidden="true" className="mdc-circular-progress__determinate-container">
                                  <svg className="mdc-circular-progress__determinate-circle-graphic" focusable="false" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                                    <circle className="mdc-circular-progress__determinate-circle" cx="50%" cy="50%" r={45} style={{"stroke-dasharray":"282.743px","stroke-width":"10%"}} />
                                  </svg>
                                </div>
                                <div aria-hidden="true" className="mdc-circular-progress__indeterminate-container">
                                  <div className="mdc-circular-progress__spinner-layer">
                                    <div className="mdc-circular-progress__circle-clipper mdc-circular-progress__circle-left">
                                      <svg className="mdc-circular-progress__indeterminate-circle-graphic ng-star-inserted" focusable="false" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="50%" cy="50%" r={45} style={{"stroke-dasharray":"282.743px","stroke-dashoffset":"141.372px","stroke-width":"10%"}} />
                                      </svg>
                                      {/* */}
                                    </div>
                      ...
                      <div _ngcontent-oko-c378 className="row clearfix">
                        <div _ngcontent-oko-c378 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c378 className="card">
                            <div _ngcontent-oko-c378 className="header">
                              <h2 _ngcontent-oko-c378>
                                <strong _ngcontent-oko-c378> Preloaders </strong>
                                Size
                              </h2>
                            </div>
                            <div _ngcontent-oko-c378 className="body">
                              <div _ngcontent-oko-c378 className="demo-preloader">
                                <div _ngcontent-oko-c378 className="preloader pl-size-xl">
                                  <div _ngcontent-oko-c378 className="spinner-layer">
                                    <div _ngcontent-oko-c378 className="circle-clipper left">
                                      <div _ngcontent-oko-c378 className="circle" />
                                    </div>
                                    <div _ngcontent-oko-c378 className="circle-clipper right">
                                      <div _ngcontent-oko-c378 className="circle" />
                                    </div>
                                  </div>
                                </div>
                                <div _ngcontent-oko-c378 className="preloader pl-size-l">
                                  <div _ngcontent-oko-c378 className="spinner-layer pl-orange">
                                    <div _ngcontent-oko-c378 className="circle-clipper left">
                                      <div _ngcontent-oko-c378 className="circle" />
                                    </div>
                                    <div _ngcontent-oko-c378 className="circle-clipper right">
                                ...
                                <div _ngcontent-oko-c378 className="preloader">
                                  <div _ngcontent-oko-c378 className="spinner-layer pl-teal">
                                    <div _ngcontent-oko-c378 className="circle-clipper left">
                                      <div _ngcontent-oko-c378 className="circle" />
                                    </div>
                                    <div _ngcontent-oko-c378 className="circle-clipper right">
                                ...
                                <div _ngcontent-oko-c378 className="preloader pl-size-sm">
                                  <div _ngcontent-oko-c378 className="spinner-layer pl-purple">
                                    <div _ngcontent-oko-c378 className="circle-clipper left">
                                      <div _ngcontent-oko-c378 className="circle" />
                                    </div>
                                    <div _ngcontent-oko-c378 className="circle-clipper right">
                                ...
                                <div _ngcontent-oko-c378 className="preloader pl-size-xs">
                                  <div _ngcontent-oko-c378 className="spinner-layer pl-red-grey">
                                    <div _ngcontent-oko-c378 className="circle-clipper left">
                                      <div _ngcontent-oko-c378 className="circle" />
                                    </div>
                                    <div _ngcontent-oko-c378 className="circle-clipper right">
                        ...
                        <div _ngcontent-oko-c378 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c378 className="card">
                            ...
                            <div _ngcontent-oko-c378 className="body">
                              <div _ngcontent-oko-c378 className="demo-preloader">
                                <div _ngcontent-oko-c378 className="preloader">
                                  <div _ngcontent-oko-c378 className="spinner-layer pl-red">
                                    <div _ngcontent-oko-c378 className="circle-clipper left">
                                      <div _ngcontent-oko-c378 className="circle" />
                                    </div>
                                    <div _ngcontent-oko-c378 className="circle-clipper right">
                                ...
                                <div _ngcontent-oko-c378 className="preloader">
                                  <div _ngcontent-oko-c378 className="spinner-layer pl-pink">
                                    <div _ngcontent-oko-c378 className="circle-clipper left">
                                      <div _ngcontent-oko-c378 className="circle" />
                                    </div>
                                    <div _ngcontent-oko-c378 className="circle-clipper right">
                                ...
                                <div _ngcontent-oko-c378 className="preloader">
                                  <div _ngcontent-oko-c378 className="spinner-layer pl-deep-purple">
                                    <div _ngcontent-oko-c378 className="circle-clipper left">
                                      <div _ngcontent-oko-c378 className="circle" />
                                    </div>
                                    <div _ngcontent-oko-c378 className="circle-clipper right">
                                ...
                                <div _ngcontent-oko-c378 className="preloader">
                                  <div _ngcontent-oko-c378 className="spinner-layer pl-indigo">
                                    <div _ngcontent-oko-c378 className="circle-clipper left">
                                      <div _ngcontent-oko-c378 className="circle" />
                                    </div>
                                    <div _ngcontent-oko-c378 className="circle-clipper right">
                                ...
                                <div _ngcontent-oko-c378 className="preloader">
                                  <div _ngcontent-oko-c378 className="spinner-layer pl-light-blue">
                                    <div _ngcontent-oko-c378 className="circle-clipper left">
                                      <div _ngcontent-oko-c378 className="circle" />
                                    </div>
                                    <div _ngcontent-oko-c378 className="circle-clipper right">
                                ...
                                <div _ngcontent-oko-c378 className="preloader">
                                  <div _ngcontent-oko-c378 className="spinner-layer pl-cyan">
                                    <div _ngcontent-oko-c378 className="circle-clipper left">
                                      <div _ngcontent-oko-c378 className="circle" />
                                    </div>
                                    <div _ngcontent-oko-c378 className="circle-clipper right">
                                ...
                                <div _ngcontent-oko-c378 className="preloader">
                                  <div _ngcontent-oko-c378 className="spinner-layer pl-green">
                                    <div _ngcontent-oko-c378 className="circle-clipper left">
                                      <div _ngcontent-oko-c378 className="circle" />
                                    </div>
                                    <div _ngcontent-oko-c378 className="circle-clipper right">
                                ...
                                <div _ngcontent-oko-c378 className="preloader">
                                  <div _ngcontent-oko-c378 className="spinner-layer pl-light-green">
                                    <div _ngcontent-oko-c378 className="circle-clipper left">
                                      <div _ngcontent-oko-c378 className="circle" />
                                    </div>
                                    <div _ngcontent-oko-c378 className="circle-clipper right">
                                ...
                                <div _ngcontent-oko-c378 className="preloader">
                                  <div _ngcontent-oko-c378 className="spinner-layer pl-lime">
                                    <div _ngcontent-oko-c378 className="circle-clipper left">
                                      <div _ngcontent-oko-c378 className="circle" />
                                    </div>
                                    <div _ngcontent-oko-c378 className="circle-clipper right">
                                ...
                                <div _ngcontent-oko-c378 className="preloader">
                                  <div _ngcontent-oko-c378 className="spinner-layer pl-yellow">
                                    <div _ngcontent-oko-c378 className="circle-clipper left">
                                      <div _ngcontent-oko-c378 className="circle" />
                                    </div>
                                    <div _ngcontent-oko-c378 className="circle-clipper right">
                                ...
                                <div _ngcontent-oko-c378 className="preloader">
                                  <div _ngcontent-oko-c378 className="spinner-layer pl-amber">
                                    <div _ngcontent-oko-c378 className="circle-clipper left">
                                      <div _ngcontent-oko-c378 className="circle" />
                                    </div>
                                    <div _ngcontent-oko-c378 className="circle-clipper right">
                                ...
                                <div _ngcontent-oko-c378 className="preloader">
                                  <div _ngcontent-oko-c378 className="spinner-layer pl-deep-orange">
                                    <div _ngcontent-oko-c378 className="circle-clipper left">
                                      <div _ngcontent-oko-c378 className="circle" />
                                    </div>
                                    <div _ngcontent-oko-c378 className="circle-clipper right">
                                ...
                                <div _ngcontent-oko-c378 className="preloader">
                                  <div _ngcontent-oko-c378 className="spinner-layer pl-brown">
                                    <div _ngcontent-oko-c378 className="circle-clipper left">
                                      <div _ngcontent-oko-c378 className="circle" />
                                    </div>
                                    <div _ngcontent-oko-c378 className="circle-clipper right">
                                ...
                                <div _ngcontent-oko-c378 className="preloader">
                                  <div _ngcontent-oko-c378 className="spinner-layer pl-grey">
                                    <div _ngcontent-oko-c378 className="circle-clipper left">
                                      <div _ngcontent-oko-c378 className="circle" />
                                    </div>
                                    <div _ngcontent-oko-c378 className="circle-clipper right">
                                ...
                                <div _ngcontent-oko-c378 className="preloader">
                                  <div _ngcontent-oko-c378 className="spinner-layer pl-black">
                                    <div _ngcontent-oko-c378 className="circle-clipper left">
                                      <div _ngcontent-oko-c378 className="circle" />
                                    </div>
                                    <div _ngcontent-oko-c378 className="circle-clipper right">
