          ...
          <app-root _nghost-oko-c137 ng-version="15.2.0">
            ...
            <app-auth-layout className="ng-star-inserted">
              <div dir="ltr">
                ...
                <app-page404 _nghost-oko-c113 className="ng-star-inserted">
                  <div _ngcontent-oko-c113 className="auth-container">
                    <div _ngcontent-oko-c113 className="row auth-main">
                      <div _ngcontent-oko-c113 className="col-sm-6 px-0 d-none d-sm-block">
                        <div _ngcontent-oko-c113 className="left-img" style={{backgroundImage: 'url(/assets/images/pages/bg-03.png)'}} />
                      </div>
                      <div _ngcontent-oko-c113 className="col-sm-6 auth-form-section">
                        <div _ngcontent-oko-c113 className="form-section">
                          <div _ngcontent-oko-c113 className="auth-wrapper">
                            <form _ngcontent-oko-c113 className="ng-untouched ng-pristine ng-valid" noValidate>
                              <span _ngcontent-oko-c113 className="error-header p-b-45">
                                404
                              </span>
                              <span _ngcontent-oko-c113 className="error-subheader p-b-5">
                                Looks Like You're Lost
                              </span>
                              <span _ngcontent-oko-c113 className="error-subheader2 p-b-5">
                                The Page You Are Looking For Not Available!
                              </span>
                              <div _ngcontent-oko-c113 className="container-auth-form-btn mt-5">
                                <button _ngcontent-oko-c113 className="auth-form-btn mdc-button mdc-button--raised mat-mdc-raised-button mat-primary mat-mdc-button-base" color="primary" mat-raised-button type="submit">
                              ...
                              <div _ngcontent-oko-c113 className="w-full p-t-15 p-b-15 text-center">
                                <div _ngcontent-oko-c113>
                                  <a _ngcontent-oko-c113 className="txt1" href="/Signin" routerlink="/Signin">
                                    Need Help?
                                  </a>
                                </div>
                              </div>
