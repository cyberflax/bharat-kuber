  ...
  return (
    <>
                      ...
                      <li _ngcontent-hni-c131 className="nav-item">
                        <button _ngcontent-hni-c131 aria-expanded="false" aria-haspopup="menu" className="mat-mdc-menu-trigger dropdown-btn nav-notification-icons mdc-button mat-mdc-button mat-unthemed mat-mdc-button-base" mat-button>
                          ...
                          <span className="mdc-button__label">
                            ...
                            <img _ngcontent-hni-c131 className="ng-star-inserted" height={16} alt="flag" src="../../assets/images/flags/us.jpg" />
          ...
          <div className={`sidebar ${isOpen ? "sidebar--open" : ""}`}>
            ...
            <Accordion defaultActiveKey="0">
              ...
              <Accordion.Item eventKey="16" style={{ margin: "auto", overflow: "hidden", width: "92%" }}>
                <Accordion.Header><img className='img1' alt="a17" src={a17} /><p className="accord-p">More Apps</p> <span _ngcontent-sas-c132 className="badge bg-orange sidebar-badge float-end ng-star-inserted">
                  4
      ...
      <div _ngcontent-hni-c142 className={`  bg2 ${isOpen ? "bg2--open " : ""}`}>
        <div _ngcontent-uaa-c192 className="block-header">
          <app-breadcrumb _ngcontent-uaa-c192 _nghost-uaa-c190>
            <div _ngcontent-uaa-c190 className="breadcrumb-main">
              <div _ngcontent-uaa-c190 className="row">
                <div _ngcontent-uaa-c190 className="col-6">
                  <div _ngcontent-uaa-c190 className="breadcrumb-title">
                    <h4 _ngcontent-uaa-c190 className="page-title">
                      Invoice
                    </h4>
                  </div>
                </div>
                <div _ngcontent-uaa-c190 className="col-6">
                  <ul _ngcontent-uaa-c190 className="breadcrumb-list">
                    <li _ngcontent-uaa-c190 className="breadcrumb-item bcrumb-1">
                      <a _ngcontent-uaa-c190 href="#/admin/dashboard/main">
                        <app-feather-icons _ngcontent-uaa-c190 _nghost-uaa-c130>
                          <i-feather _ngcontent-uaa-c130 _nghost-uaa-c112 className="breadcrumb-icon">
                    ...
                    <li _ngcontent-uaa-c190 className="breadcrumb-item ng-star-inserted">
                      Accounts
                    </li>
                   
                    <li _ngcontent-uaa-c190 className="breadcrumb-item active">
                      Invoice
                    </li>
                  </ul>
                </div>
        ...
        <div _ngcontent-uaa-c192 className="row clearfix">
          <div _ngcontent-uaa-c192 className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div _ngcontent-uaa-c192 className="card">
              <div _ngcontent-uaa-c192 className="body">
                <div _ngcontent-uaa-c192 className="row">
                  <div _ngcontent-uaa-c192 className="col-md-12">
                    <div _ngcontent-uaa-c192 className="white-box">
                      <h3 _ngcontent-uaa-c192>
                        <b _ngcontent-uaa-c192> INVOICE </b>
                        <span _ngcontent-uaa-c192 className="float-end">
                          #345766
                        </span>
                      </h3>
                      <hr _ngcontent-uaa-c192 />
                      <div _ngcontent-uaa-c192 className="row">
                        <div _ngcontent-uaa-c192 className="col-md-12">
                          <div _ngcontent-uaa-c192 className="float-start">
                            <address _ngcontent-uaa-c192>
                              <img _ngcontent-uaa-c192 alt="logo" className="logo-default" src="../../assets/images/logo.png" />
                              <span _ngcontent-uaa-c192 className="fs-2 fw-bold m-2 align-middle">
                                Cyber-Instant
                              </span>
                              <p _ngcontent-uaa-c192 className="m-l-5">
                                D 103, Cyber-Instant Solutions,
                                <br _ngcontent-uaa-c192 />
                                Opp. Town Hall,
                                <br _ngcontent-uaa-c192 />
                                Sardar Patel Road,
                                <br _ngcontent-uaa-c192 />
                          ...
                          <div _ngcontent-uaa-c192 className="float-end text-end">
                            <address _ngcontent-uaa-c192>
                              <p _ngcontent-uaa-c192 className="addr-font-h3 font-bold">
                                BILL TO :
                              </p>
                              <p _ngcontent-uaa-c192 className="font-bold addr-font-h4">
                                Jayesh Patel
                              </p>
                              <p _ngcontent-uaa-c192 className="m-l-30">
                                207, Prem Sagar Appt.,
                                <br _ngcontent-uaa-c192 />
                              ...
                              <p _ngcontent-uaa-c192 className="m-t-30">
                                <b _ngcontent-uaa-c192>
                                  Invoice Date :
                                </b>
                                <i _ngcontent-uaa-c192 className="fa fa-calendar">
                                </i>
                                14th July 2017
                              </p>
                              <p _ngcontent-uaa-c192>
                                <b _ngcontent-uaa-c192> Status : </b>
                                <span _ngcontent-uaa-c192 className="label label-success">
                                  Success
                                </span>
                              </p>
                            </address>
                        ...
                        <div _ngcontent-uaa-c192 className="col-md-12">
                          <div _ngcontent-uaa-c192 className="table-responsive m-t-40">
                            <table _ngcontent-uaa-c192 className="table table-hover text-center">
                              <thead _ngcontent-uaa-c192>
                                <tr _ngcontent-uaa-c192>
                                  <th _ngcontent-uaa-c192 className="text-center">
                                    #
                                  </th>
                                  <th _ngcontent-uaa-c192>
                                    Project Name
                                  </th>
                                  <th _ngcontent-uaa-c192>
                                    Details
                                  ...
                                  <th _ngcontent-uaa-c192>Total</th>
                                </tr>
                              </thead>
                              <tbody _ngcontent-uaa-c192>
                                <tr _ngcontent-uaa-c192>
                                  <td _ngcontent-uaa-c192 className="text-center">
                                    1
                                  </td>
                                  <td _ngcontent-uaa-c192>
                                    Angular App
                                  </td>
                                  <td _ngcontent-uaa-c192>
                                    Ecommerce app
                                  </td>
                                  <td _ngcontent-uaa-c192>23</td>
                                  <td _ngcontent-uaa-c192>$20</td>
                                  <td _ngcontent-uaa-c192>$460</td>
                                </tr>
                                <tr _ngcontent-uaa-c192>
                                  <td _ngcontent-uaa-c192 className="text-center">
                                    2
                        ...
                        <div _ngcontent-uaa-c192 className="col-md-12">
                          <div _ngcontent-uaa-c192 className="float-end m-t-30 text-end">
                            <p _ngcontent-uaa-c192>
                            ...
                            <hr _ngcontent-uaa-c192 />
                            <h3 _ngcontent-uaa-c192>
                              <b _ngcontent-uaa-c192> Total : </b>
                              $2760
                            </h3>
                          </div>
                          <div _ngcontent-uaa-c192 className="clearfix" />
                          <hr _ngcontent-uaa-c192 />
                          <div _ngcontent-uaa-c192 className="text-end">
                            <button _ngcontent-uaa-c192 className="mdc-button mdc-button--unelevated mat-mdc-unelevated-button mat-primary mat-mdc-button-base" color="primary" mat-flat-button>
                              <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                              </span>
                              <span className="mdc-button__label">
                                <i _ngcontent-uaa-c192 className="fas fa-print">
                                </i>
                                Print
                              </span>
