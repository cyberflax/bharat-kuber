  ...
  return (
    <>
      ...
      <div _ngcontent-hni-c142 className={`  bg2 ${isOpen ? "bg2--open " : ""}`}>
        <div _ngcontent-oko-c310 className="block-header">
          <app-breadcrumb _ngcontent-oko-c310 _nghost-oko-c141>
        ...
        <div _ngcontent-oko-c310 className="row clearfix">
          <div _ngcontent-oko-c310 className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <div _ngcontent-oko-c310 className="card">
              <div _ngcontent-oko-c310 className="header">
                <h2 _ngcontent-oko-c310>
                  <strong _ngcontent-oko-c310>
                    Payment Information
                  </strong>
                </h2>
