          ...
          <app-root _nghost-oko-c137 ng-version="15.2.0">
            ...
            <app-main-layout className="ng-star-inserted">
              ...
              <div dir="ltr">
                ...
                <app-chat _nghost-oko-c368 className="ng-star-inserted">
                  <section _ngcontent-oko-c368 className="content">
                    <div _ngcontent-oko-c368 className="content-block">
                      <div _ngcontent-oko-c368 className="block-header">
                        <app-breadcrumb _ngcontent-oko-c368 _nghost-oko-c141>
                      ...
                      <div _ngcontent-oko-c368 className="row">
                        <div _ngcontent-oko-c368 className="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                          <div _ngcontent-oko-c368 className="card">
                            <div _ngcontent-oko-c368 className="body">
                              <div _ngcontent-oko-c368 className="people-list" id="plist">
                                <div _ngcontent-oko-c368 className="form-line m-b-15">
                                  <input _ngcontent-oko-c368 className="form-control" placeholder="Search..." type="text" />
                                </div>
                                <div _ngcontent-oko-c368 className="tab-content">
                                  <ng-scrollbar _ngcontent-oko-c368 _nghost-oko-c129 className="ng-scrollbar" style={{height: '590px'}} visibility="hover">
                                    <div _ngcontent-oko-c129 appearance="compact" className="ng-scrollbar-wrapper" deactivated="false" dir="ltr" horizontalused="false" ishorizontallyscrollable="false" isverticallyscrollable="true" pointereventsmethod="viewport" position="native" track="vertical" verticalused="true" visibility="hover">
                                      <div _ngcontent-oko-c129 className="ng-scroll-viewport-wrapper">
                                        <div _ngcontent-oko-c129 className="ng-native-scrollbar-hider ng-scroll-viewport" hidenativescrollbar scrollviewport style={{nativeScrollbarSize: '0px'}}>
                                          <div _ngcontent-oko-c129 className="ng-scroll-content">
                                            <div _ngcontent-oko-c368 id="chat_user">
                                              <ul _ngcontent-oko-c368 className="chat-list list-unstyled m-b-0">
                                                <li _ngcontent-oko-c368 className="clearfix active">
                                                  <img _ngcontent-oko-c368 alt="avatar" src="../assets/images/user/user1.jpg" />
                                                  <div _ngcontent-oko-c368 className="about">
                                                    <div _ngcontent-oko-c368 className="name">
                                                      William Smith
                                                    </div>
                                                    <div _ngcontent-oko-c368 className="status">
                                                      <i _ngcontent-oko-c368 className="material-icons offline">
                                                        fiber_manual_record
                                                      </i>
                                                      left 7 mins ago
                                                    </div>
                                                ...
                                                <li _ngcontent-oko-c368 className="clearfix">
                                                  <img _ngcontent-oko-c368 alt="avatar" src="../assets/images/user/user2.jpg" />
                                                  <div _ngcontent-oko-c368 className="about">
                                                    <div _ngcontent-oko-c368 className="name">
                                                      Martha Williams
                                                    </div>
                                                ...
                                                <li _ngcontent-oko-c368 className="clearfix">
                                                  <img _ngcontent-oko-c368 alt="avatar" src="../assets/images/user/user3.jpg" />
                                                  <div _ngcontent-oko-c368 className="about">
                                                    <div _ngcontent-oko-c368 className="name">
                                                      Joseph Clark
                                                    </div>
                                                    <div _ngcontent-oko-c368 className="status">
                                                      <i _ngcontent-oko-c368 className="material-icons online">
                                                        fiber_manual_record
                                                      </i>
                                                      online
                                                    </div>
                                                ...
                                                <li _ngcontent-oko-c368 className="clearfix">
                                                  <img _ngcontent-oko-c368 alt="avatar" src="../assets/images/user/user4.jpg" />
                                                  <div _ngcontent-oko-c368 className="about">
                                                    <div _ngcontent-oko-c368 className="name">
                                                      Nancy Taylor
                                                    </div>
                                                ...
                                                <li _ngcontent-oko-c368 className="clearfix">
                                                  <img _ngcontent-oko-c368 alt="avatar" src="../assets/images/user/user5.jpg" />
                                                  <div _ngcontent-oko-c368 className="about">
                                                    <div _ngcontent-oko-c368 className="name">
                                                      Margaret Wilson
                                                    </div>
                                                ...
                                                <li _ngcontent-oko-c368 className="clearfix">
                                                  <img _ngcontent-oko-c368 alt="avatar" src="../assets/images/user/user6.jpg" />
                                                  <div _ngcontent-oko-c368 className="about">
                                                    <div _ngcontent-oko-c368 className="name">
                                                      Joseph Jones
                                                    </div>
                                                ...
                                                <li _ngcontent-oko-c368 className="clearfix">
                                                  <img _ngcontent-oko-c368 alt="avatar" src="../assets/images/user/user7.jpg" />
                                                  <div _ngcontent-oko-c368 className="about">
                                                    <div _ngcontent-oko-c368 className="name">
                                                      Jane Brown
                                                    </div>
                                                ...
                                                <li _ngcontent-oko-c368 className="clearfix">
                                                  <img _ngcontent-oko-c368 alt="avatar" src="../assets/images/user/user8.jpg" />
                                                  <div _ngcontent-oko-c368 className="about">
                                                    <div _ngcontent-oko-c368 className="name">
                                                      Eliza Johnson
                                                    </div>
                                                ...
                                                <li _ngcontent-oko-c368 className="clearfix">
                                                  <img _ngcontent-oko-c368 alt="avatar" src="../assets/images/user/user9.jpg" />
                                                  <div _ngcontent-oko-c368 className="about">
                                                    <div _ngcontent-oko-c368 className="name">
                                                      David Wilson
                                                    </div>
                                      ...
                                      <scrollbar-y _ngcontent-oko-c129 _nghost-oko-c127 className="scrollbar-control ng-star-inserted" fit="false" scrollable="true">
                                        <div _ngcontent-oko-c127 className="ng-scrollbar-track" scrollbartracky>
                                          <div _ngcontent-oko-c127 className="ng-scrollbar-thumb" scrollbarthumby style={{height: '340px', transform: 'translate3d(0px, 0px, 0px)'}} />
                                        </div>
                                      </scrollbar-y>
                                      {/* */}
                                      {/* */}
                        ...
                        <div _ngcontent-oko-c368 className="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                          <div _ngcontent-oko-c368 className="card">
                            <div _ngcontent-oko-c368 className="chat">
                              <div _ngcontent-oko-c368 className="chat-header clearfix">
                                <img _ngcontent-oko-c368 alt="avatar" src="../assets/images/user/user2.jpg" />
                                <div _ngcontent-oko-c368 className="chat-about">
                                  <div _ngcontent-oko-c368 className="chat-with">
                                    Maria Smith
                                  </div>
                                  <div _ngcontent-oko-c368 className="chat-num-messages">
                                    2 new messages
                                  </div>
                                </div>
                              </div>
                              <ng-scrollbar _ngcontent-oko-c368 _nghost-oko-c129 className="ng-scrollbar" style={{height: '450px'}} visibility="hover">
                                <div _ngcontent-oko-c129 appearance="compact" className="ng-scrollbar-wrapper" deactivated="false" dir="ltr" horizontalused="false" ishorizontallyscrollable="false" isverticallyscrollable="true" pointereventsmethod="viewport" position="native" track="vertical" verticalused="true" visibility="hover">
                                  <div _ngcontent-oko-c129 className="ng-scroll-viewport-wrapper">
                                    <div _ngcontent-oko-c129 className="ng-native-scrollbar-hider ng-scroll-viewport" hidenativescrollbar scrollviewport style={{nativeScrollbarSize: '0px'}}>
                                      <div _ngcontent-oko-c129 className="ng-scroll-content">
                                        <div _ngcontent-oko-c368 className="chat-history" id="chat-conversation">
                                          <ul _ngcontent-oko-c368>
                                            <li _ngcontent-oko-c368 className="clearfix">
                                              <div _ngcontent-oko-c368 className="message-data text-end">
                                                <span _ngcontent-oko-c368 className="message-data-time">
                                                  10:10 AM, Today
                                                </span>
                                                <span _ngcontent-oko-c368 className="message-data-name">
                                                  Maria
                                                </span>
                                              </div>
                                              <div _ngcontent-oko-c368 className="message other-message float-end">
                                                Hi Robert , how are you? How is your
                                                work going on?
                                              </div>
                                            </li>
                                            <li _ngcontent-oko-c368>
                                              <div _ngcontent-oko-c368 className="message-data">
                                                <span _ngcontent-oko-c368 className="message-data-name">
                                                  Robert
                                                </span>
                                                <span _ngcontent-oko-c368 className="message-data-time">
                                              ...
                                              <div _ngcontent-oko-c368 className="message my-message">
                                                <p _ngcontent-oko-c368>
                                                  Its good. We completed almost all
                                                  task assign by our manager.
                                                </p>
                                                <div _ngcontent-oko-c368 className="row" />
                                              </div>
                                            </li>
                                            <li _ngcontent-oko-c368>
                                              ...
                                              <div _ngcontent-oko-c368 className="message my-message">
                                                <p _ngcontent-oko-c368>
                                                  How are you feel today? What's about
                                                  vacation?.
                                                </p>
                                                <div _ngcontent-oko-c368 className="row" />
                                              </div>
                                  ...
                                  <scrollbar-y _ngcontent-oko-c129 _nghost-oko-c127 className="scrollbar-control ng-star-inserted" fit="false" scrollable="true">
                                    <div _ngcontent-oko-c127 className="ng-scrollbar-track" scrollbartracky>
                                      <div _ngcontent-oko-c127 className="ng-scrollbar-thumb" scrollbarthumby style={{height: '348px', transform: 'translate3d(0px, 0px, 0px)'}} />
                                    </div>
                                  </scrollbar-y>
                                  {/* */}
                                  {/* */}
                              ...
                              <div _ngcontent-oko-c368 className="chat-message clearfix">
                                <div _ngcontent-oko-c368 className="form-group">
                                  <div _ngcontent-oko-c368 className="form-line">
                                    <mat-form-field _ngcontent-oko-c368 appearance="outline" className="mat-mdc-form-field example-full-width ng-tns-c67-332 mat-mdc-form-field-type-mat-input mat-form-field-appearance-outline mat-primary ng-star-inserted">
                                      {/* */}
                                      <div className="mat-mdc-text-field-wrapper mdc-text-field ng-tns-c67-332 mdc-text-field--outlined mdc-text-field--no-label">
                                        {/* */}
                                        <div className="mat-mdc-form-field-flex ng-tns-c67-332">
                                          <div className="mdc-notched-outline ng-tns-c67-332 mdc-notched-outline--no-label ng-star-inserted" matformfieldnotchedoutline>
                                          ...
                                          {/* */}
                                          {/* */}
                                          <div className="mat-mdc-form-field-infix ng-tns-c67-332">
                                            {/* */}
                                            <input _ngcontent-oko-c368 aria-required="true" className="mat-mdc-input-element ng-tns-c67-332 mat-mdc-form-field-input-control mdc-text-field__input cdk-text-field-autofill-monitored" id="mat-input-73" matinput placeholder="Enter text here.." required />
                                          </div>
                                          {/* */}
                                          {/* */}
                                        </div>
                                      ...
                                      <div className="mat-mdc-form-field-subscript-wrapper mat-mdc-form-field-bottom-align ng-tns-c67-332">
                                        {/* */}
                                        <div className="mat-mdc-form-field-hint-wrapper ng-tns-c67-332 ng-trigger ng-trigger-transitionMessages ng-star-inserted" style={{opacity: 1, transform: 'translateY(0%)'}}>
                                          {/* */}
                                          <div className="mat-mdc-form-field-hint-spacer ng-tns-c67-332" />
                                        </div>
                                        {/* */}
                                      </div>
                                    </mat-form-field>
                                ...
                                <div _ngcontent-oko-c368 className="chat-upload">
                                  <button _ngcontent-oko-c368 className="bg-deep-orange msr-2 mdc-fab mdc-fab--mini mat-mdc-mini-fab mat-accent mat-mdc-button-base" mat-mini-fab>
                                    <span className="mat-mdc-button-persistent-ripple mdc-fab__ripple">
                                    </span>
                                    <i _ngcontent-oko-c368 className="material-icons">
                                      attach_file
                                    </i>
                                  ...
                                  <button _ngcontent-oko-c368 className="bg-deep-orange mdc-fab mdc-fab--mini mat-mdc-mini-fab mat-accent mat-mdc-button-base" mat-mini-fab>
                                    <span className="mat-mdc-button-persistent-ripple mdc-fab__ripple">
                                    </span>
                                    <i _ngcontent-oko-c368 className="material-icons">
                                      insert_emoticon
