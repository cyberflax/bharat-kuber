          ...
          <app-root _nghost-oko-c137 ng-version="15.2.0">
            ...
            <app-main-layout className="ng-star-inserted">
              ...
              <div dir="ltr">
                ...
                <app-contact-grid _nghost-oko-c369 className="ng-star-inserted">
                  <section _ngcontent-oko-c369 className="content">
                    <div _ngcontent-oko-c369 className="content-block">
                      <div _ngcontent-oko-c369 className="block-header">
                        <app-breadcrumb _ngcontent-oko-c369 _nghost-oko-c141>
                      ...
                      <div _ngcontent-oko-c369 className="row clearfix">
                        <div _ngcontent-oko-c369 className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                          <div _ngcontent-oko-c369 className="card">
                            <div _ngcontent-oko-c369 className="header">
                              <div _ngcontent-oko-c369 className="col-xs-12 col-sm-6">
                                <h2 _ngcontent-oko-c369>
                                  <strong _ngcontent-oko-c369> Contact </strong>
                                  Grid
                                </h2>
                              </div>
                            </div>
                            <div _ngcontent-oko-c369 className="body">
                              <div _ngcontent-oko-c369 className="row">
                                <div _ngcontent-oko-c369 className="col-md-4">
                                  <div _ngcontent-oko-c369 className="card border-apply">
                                    <div _ngcontent-oko-c369 className="m-b-20">
                                      <div _ngcontent-oko-c369 className="contact-grid">
                                        <div _ngcontent-oko-c369 className="profile-header l-bg-purple-dark">
                                          <div _ngcontent-oko-c369 className="user-name">
                                            Pooja Patel
                                          </div>
                                          <div _ngcontent-oko-c369 className="name-center">
                                            General Manager
                                          </div>
                                        </div>
                                        <img _ngcontent-oko-c369 alt="" className="user-img" src="../assets/images/user/usrbig1.jpg" />
                                        <p _ngcontent-oko-c369>
                                          A-103, shyam gokul flats, Mahatma Road
                                          <br _ngcontent-oko-c369 />
                                          Mumbai
                                        </p>
                                        <div _ngcontent-oko-c369>
                                          <span _ngcontent-oko-c369 className="phone">
                                            <i _ngcontent-oko-c369 className="material-icons">
                                              phone
                                            </i>
                                            264-625-2583
                                          </span>
                                        </div>
                                        <div _ngcontent-oko-c369 className="profile-userbuttons">
                                          <button _ngcontent-oko-c369 className="mdc-button mdc-button--unelevated mat-mdc-unelevated-button mat-primary mat-mdc-button-base" color="primary" mat-flat-button>
                                            <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                                            </span>
                                            <span className="mdc-button__label">
                                              Read More
                                ...
                                <div _ngcontent-oko-c369 className="col-md-4">
                                  <div _ngcontent-oko-c369 className="card border-apply">
                                    <div _ngcontent-oko-c369 className="m-b-20">
                                      <div _ngcontent-oko-c369 className="contact-grid">
                                        <div _ngcontent-oko-c369 className="profile-header bg-cyan">
                                          <div _ngcontent-oko-c369 className="user-name">
                                            Smita Patil
                                          </div>
                                          <div _ngcontent-oko-c369 className="name-center">
                                        ...
                                        <img _ngcontent-oko-c369 alt="" className="user-img" src="../assets/images/user/usrbig2.jpg" />
                                        <p _ngcontent-oko-c369>
                                ...
                                <div _ngcontent-oko-c369 className="col-md-4">
                                  <div _ngcontent-oko-c369 className="card border-apply">
                                    <div _ngcontent-oko-c369 className="m-b-20">
                                      <div _ngcontent-oko-c369 className="contact-grid">
                                        <div _ngcontent-oko-c369 className="profile-header bg-dark">
                                          <div _ngcontent-oko-c369 className="user-name">
                                            John Smith
                                          </div>
                                          <div _ngcontent-oko-c369 className="name-center">
                                        ...
                                        <img _ngcontent-oko-c369 alt="" className="user-img" src="../assets/images/user/usrbig3.jpg" />
                                        <p _ngcontent-oko-c369>
                              ...
                              <div _ngcontent-oko-c369 className="row">
                                <div _ngcontent-oko-c369 className="col-md-4">
                                  <div _ngcontent-oko-c369 className="card border-apply">
                                    <div _ngcontent-oko-c369 className="m-b-20">
                                      <div _ngcontent-oko-c369 className="contact-grid">
                                        <div _ngcontent-oko-c369 className="profile-header l-bg-orange">
                                          <div _ngcontent-oko-c369 className="user-name">
                                            Pooja Patel
                                          </div>
                                          <div _ngcontent-oko-c369 className="name-center">
                                        ...
                                        <img _ngcontent-oko-c369 alt="" className="user-img" src="../assets/images/user/usrbig4.jpg" />
                                        <p _ngcontent-oko-c369>
                                          A-103, shyam gokul flats, Mahatma Road
                                          <br _ngcontent-oko-c369 />
                                          Mumbai
                                ...
                                <div _ngcontent-oko-c369 className="col-md-4">
                                  <div _ngcontent-oko-c369 className="card border-apply">
                                    <div _ngcontent-oko-c369 className="m-b-20">
                                      <div _ngcontent-oko-c369 className="contact-grid">
                                        <div _ngcontent-oko-c369 className="profile-header bg-green">
                                          <div _ngcontent-oko-c369 className="user-name">
                                            Smita Patil
                                          </div>
                                          <div _ngcontent-oko-c369 className="name-center">
                                        ...
                                        <img _ngcontent-oko-c369 alt="" className="user-img" src="../assets/images/user/usrbig5.jpg" />
                                        <p _ngcontent-oko-c369>
                                          45, Krishna Tower, Near Bus Stop, Satellite,
                                          <br _ngcontent-oko-c369 />
                                          Ahmedabad
                                ...
                                <div _ngcontent-oko-c369 className="col-md-4">
                                  <div _ngcontent-oko-c369 className="card border-apply">
                                    <div _ngcontent-oko-c369 className="m-b-20">
                                      <div _ngcontent-oko-c369 className="contact-grid">
                                        <div _ngcontent-oko-c369 className="profile-header l-bg-red">
                                          <div _ngcontent-oko-c369 className="user-name">
                                            John Smith
                                          </div>
                                          <div _ngcontent-oko-c369 className="name-center">
                                        ...
                                        <img _ngcontent-oko-c369 alt="" className="user-img" src="../assets/images/user/usrbig6.jpg" />
                                        <p _ngcontent-oko-c369>
                                          456, Estern evenue, Courtage area,
                                          <br _ngcontent-oko-c369 />
                                          New York
                              ...
                              <div _ngcontent-oko-c369 className="row">
                                <div _ngcontent-oko-c369 className="col-md-4">
                                  <div _ngcontent-oko-c369 className="card border-apply">
                                    <div _ngcontent-oko-c369 className="m-b-20">
                                      <div _ngcontent-oko-c369 className="contact-grid">
                                        <div _ngcontent-oko-c369 className="profile-header bg-indigo">
                                          <div _ngcontent-oko-c369 className="user-name">
                                            Pooja Patel
                                          </div>
                                          <div _ngcontent-oko-c369 className="name-center">
                                        ...
                                        <img _ngcontent-oko-c369 alt="" className="user-img" src="../assets/images/user/usrbig7.jpg" />
                                        <p _ngcontent-oko-c369>
                                          A-103, shyam gokul flats, Mahatma Road
                                          <br _ngcontent-oko-c369 />
                                          Mumbai
                                ...
                                <div _ngcontent-oko-c369 className="col-md-4">
                                  <div _ngcontent-oko-c369 className="card border-apply">
                                    <div _ngcontent-oko-c369 className="m-b-20">
                                      <div _ngcontent-oko-c369 className="contact-grid">
                                        <div _ngcontent-oko-c369 className="profile-header bg-brown">
                                          <div _ngcontent-oko-c369 className="user-name">
                                            Smita Patil
                                          </div>
                                          <div _ngcontent-oko-c369 className="name-center">
                                        ...
                                        <img _ngcontent-oko-c369 alt="" className="user-img" src="../assets/images/user/usrbig8.jpg" />
                                        <p _ngcontent-oko-c369>
                                          45, Krishna Tower, Near Bus Stop, Satellite,
                                          <br _ngcontent-oko-c369 />
                                          Ahmedabad
                                ...
                                <div _ngcontent-oko-c369 className="col-md-4">
                                  <div _ngcontent-oko-c369 className="card border-apply">
                                    <div _ngcontent-oko-c369 className="m-b-20">
                                      <div _ngcontent-oko-c369 className="contact-grid">
                                        <div _ngcontent-oko-c369 className="profile-header bg-yellow">
                                          <div _ngcontent-oko-c369 className="user-name">
                                            John Smith
                                          </div>
                                          <div _ngcontent-oko-c369 className="name-center">
                                        ...
                                        <img _ngcontent-oko-c369 alt="" className="user-img" src="../assets/images/user/usrbig9.jpg" />
                                        <p _ngcontent-oko-c369>
                                          456, Estern evenue, Courtage area,
                                          <br _ngcontent-oko-c369 />
                                          New York
