...
export default function Editholiday() {
  ...
  return (
    ...
    <div _ngcontent-hni-c142 className={`  bg2 ${isOpen ? "bg2--open " : ""}`}>
                      <div _ngcontent-oko-c263 className="block-header">
                        <app-breadcrumb _ngcontent-oko-c263 _nghost-oko-c141>
                      ...
                      <div _ngcontent-oko-c263 className="row clearfix">
                        <div _ngcontent-oko-c263 className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                          <div _ngcontent-oko-c263 className="card">
                            <div _ngcontent-oko-c263 className="header">
                              <h2 _ngcontent-oko-c263>
                                <strong _ngcontent-oko-c263> Edit Holiday </strong>
                              </h2>
                            </div>
                            <Validform/>
                          </div>
