...
// import Madhav from "./madhav/Madhav";
// import madhav from "./madhav/Madhav"
// import { Link } from "react-router-dom";
...
>
          ...
          <app-root _nghost-hni-c137 ng-version="15.2.0">
            <app-page-loader _ngcontent-hni-c137 _nghost-hni-c136>
              <ngx-loading-bar _ngcontent-hni-c136 _nghost-hni-c135 color="#3173D6" fixed="true" style={{color: 'rgb(49, 115, 214)'}}>
                {/* */}
              </ngx-loading-bar>
            </app-page-loader>
            <router-outlet _ngcontent-hni-c137> </router-outlet>
                    ...
                    <div _ngcontent-hni-c131 className="collapse navbar-collapse">
                      ...
                      <ul _ngcontent-hni-c131 className="nav navbar-nav navbar-right">
                        ...
                        <li _ngcontent-hni-c131 className="nav-item btnNotification" ngbdropdown>
                          <button _ngcontent-hni-c131 onClick={handleTrigger} aria-expanded="false" aria-haspopup="menu" className="mat-mdc-menu-trigger nav-notification-icons mdc-button mat-mdc-button mat-unthemed mat-mdc-button-base" mat-button>
                            <span className="mat-mdc-button-persistent-ripple mdc-button__ripple">
                            </span>
                            <span className="mdc-button__label">
                              <app-feather-icons _ngcontent-hni-c131 _nghost-hni-c130>
        ...
        <div className={`sidebar ${isOpen ? "sidebar--open" : ""}`}>
          ...
          <div className="sidebar-position">
            ...
            <span>Position 4</span>
              ...
              <app-right-sidebar _nghost-hni-c133>
                <div _ngcontent-hni-c133 className="settingSidebar">
                  <a _ngcontent-hni-c133 className="settingPanelToggle" href="javascript:void(0)">
                    <app-feather-icons _ngcontent-hni-c133 _nghost-hni-c130>
                      <i-feather _ngcontent-hni-c130 _nghost-hni-c112 className="setting-sidebar-icon">
                  ...
                  <ng-scrollbar _ngcontent-hni-c133 _nghost-hni-c129 className="ng-scrollbar" style={{height: '588px'}} visibility="hover">
                    <div _ngcontent-hni-c129 appearance="compact" className="ng-scrollbar-wrapper" deactivated="false" dir="ltr" horizontalused="false" ishorizontallyscrollable="false" isverticallyscrollable="true" pointereventsmethod="viewport" position="native" track="vertical" verticalused="true" visibility="hover">
                      <div _ngcontent-hni-c129 className="ng-scroll-viewport-wrapper">
                        <div _ngcontent-hni-c129 className="ng-native-scrollbar-hider ng-scroll-viewport" hidenativescrollbar scrollviewport style={{nativeScrollbarSize: '0px'}}>
                          <div _ngcontent-hni-c129 className="ng-scroll-content">
                            <div _ngcontent-hni-c133 className="settingSidebar-body ps-container ps-theme-default">
                              <div _ngcontent-hni-c133 className="fade show active">
                                <div _ngcontent-hni-c133 className="setting-panel-header">
                                  Setting Panel
                                </div>
                                <div _ngcontent-hni-c133 className="p-15 border-bottom">
                                  <h6 _ngcontent-hni-c133 className="font-medium m-b-10">
                                    Select Layout
                                  </h6>
                                  <div _ngcontent-hni-c133 className="flex flex-wrap hiddenradio">
                                    <div _ngcontent-hni-c133 className="flex flex-col">
                                      <label _ngcontent-hni-c133>
                                        <input _ngcontent-hni-c133 name="value" type="radio" defaultValue="light" />
                                        <img _ngcontent-hni-c133 src="../../assets/images/light.png" />
                                      </label>
                                      <div _ngcontent-hni-c133 className="mt-1 text-md text-center">
                                        Light
                                      </div>
                                    </div>
                                    <div _ngcontent-hni-c133 className="flex flex-col mt-3">
                                      <label _ngcontent-hni-c133>
                                        <input _ngcontent-hni-c133 name="value" type="radio" defaultValue="dark" />
                                        <img _ngcontent-hni-c133 src="../../assets/images/dark.png" />
                                      </label>
                                      <div _ngcontent-hni-c133 className="mt-1 text-md text-center">
                                        Dark
                                      </div>
                                ...
                                <div _ngcontent-hni-c133 className="rightSetting">
                                  <h6 _ngcontent-hni-c133 className="font-medium m-b-10">
                                    Sidebar Menu Color
                                  </h6>
                                  <mat-button-toggle-group _ngcontent-hni-c133 aria-disabled="false" className="mat-button-toggle-group mt-2 mat-button-toggle-group-appearance-standard" role="group">
                                    <mat-button-toggle _ngcontent-hni-c133 className="mat-button-toggle mat-button-toggle-checked mat-button-toggle-appearance-standard" id="mat-button-toggle-1" role="presentation" value="light">
                                    ...
                                    <mat-button-toggle _ngcontent-hni-c133 className="mat-button-toggle mat-button-toggle-appearance-standard" id="mat-button-toggle-2" role="presentation" value="dark">
                                ...
                                <div _ngcontent-hni-c133 className="p-15 border-bottom">
                                  ...
                                  <div _ngcontent-hni-c133 className="theme-setting-options">
                                    <ul _ngcontent-hni-c133 className="choose-theme list-unstyled mb-0">
                                      <li _ngcontent-hni-c133 className="active" data-theme="white">
                                        <div _ngcontent-hni-c133 className="white" />
                                      </li>
                                      <li _ngcontent-hni-c133 data-theme="black">
                                        <div _ngcontent-hni-c133 className="black" />
                                      </li>
                                      <li _ngcontent-hni-c133 data-theme="purple">
                                        <div _ngcontent-hni-c133 className="purple" />
                                      </li>
                                      <li _ngcontent-hni-c133 data-theme="orange">
                                        <div _ngcontent-hni-c133 className="orange" />
                                      </li>
                                      <li _ngcontent-hni-c133 data-theme="cyan">
                                        <div _ngcontent-hni-c133 className="cyan" />
                                      </li>
                                      <li _ngcontent-hni-c133 data-theme="green">
                                        <div _ngcontent-hni-c133 className="green" />
                                      </li>
                                      <li _ngcontent-hni-c133 data-theme="blue">
                                        <div _ngcontent-hni-c133 className="blue" />
                                      </li>
                                    </ul>
                                  </div>
                                </div>
                                <div _ngcontent-hni-c133 className="rightSetting">
                                  ...
                                  <mat-slide-toggle _ngcontent-hni-c133 className="mat-mdc-slide-toggle mt-2 mat-accent" id="mat-mdc-slide-toggle-1">
                      ...
                      {/* */}
                      <scrollbar-y _ngcontent-hni-c129 _nghost-hni-c127 className="scrollbar-control ng-star-inserted" fit="false" scrollable="true">
                        <div _ngcontent-hni-c127 className="ng-scrollbar-track" scrollbartracky>
                          <div _ngcontent-hni-c127 className="ng-scrollbar-thumb" scrollbarthumby style={{height: '494px', transform: 'translate3d(0px, 0px, 0px)'}} />
                        </div>
                      </scrollbar-y>
                      {/* */}
                      {/* */}
              ...
              <div dir="ltr">
                ...
                <app-main _nghost-hni-c142 className="ng-star-inserted">
                  <section _ngcontent-hni-c142 className="content">
                    <div _ngcontent-hni-c142 className="content-block">
          ...
          <div className="cdk-describedby-message-container cdk-visually-hidden" style={{visibility: 'hidden'}}>
            <div id="cdk-describedby-message-hni-1-2" role="tooltip">Edit</div>
            <div id="cdk-describedby-message-hni-1-3" role="tooltip">Delete</div>
          </div>
