  ...
  return (
    <>
      ...
      <div _ngcontent-hni-c142 className={`  bg2 ${isOpen ? "bg2--open " : ""}`}>
        <div _ngcontent-oko-c305 className="block-header">
          <app-breadcrumb _ngcontent-oko-c305 _nghost-oko-c141>
        ...
        <div _ngcontent-oko-c305 className="row clearfix">
          <div _ngcontent-oko-c305 className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <div _ngcontent-oko-c305 className="card">
              <div _ngcontent-oko-c305 className="header">
                <h2 _ngcontent-oko-c305>
                  <strong _ngcontent-oko-c305> Add Client </strong>
                </h2>
              </div>
              <Clientform />
            </div>
