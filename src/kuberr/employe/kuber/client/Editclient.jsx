...
export default function Editclient() {
  ...
  return (
    ...
    <div _ngcontent-hni-c142 className={`  bg2 ${isOpen ? "bg2--open " : ""}`}>
                    <div _ngcontent-oko-c306 className="block-header">
                      <app-breadcrumb _ngcontent-oko-c306 _nghost-oko-c141>
                    ...
                    <div _ngcontent-oko-c306 className="row clearfix">
                      <div _ngcontent-oko-c306 className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                      <div _ngcontent-oko-c306 className="card">
                          <div _ngcontent-oko-c306 className="header">
                            <h2 _ngcontent-oko-c306>Edit Client</h2>
                          </div>
                          <Clientform/>
                          </div>
                      </div>
