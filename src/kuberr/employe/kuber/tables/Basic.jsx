          ...
          <app-root _nghost-oko-c137 ng-version="15.2.0">
            ...
            <app-main-layout className="ng-star-inserted">
              ...
              <div dir="ltr">
                ...
                <app-basic-table _nghost-oko-c429 className="ng-star-inserted">
                  <section _ngcontent-oko-c429 className="content">
                    <div _ngcontent-oko-c429 className="content-block">
                      <div _ngcontent-oko-c429 className="block-header">
                        <app-breadcrumb _ngcontent-oko-c429 _nghost-oko-c141>
                      ...
                      <div _ngcontent-oko-c429 className="row clearfix">
                        <div _ngcontent-oko-c429 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c429 className="card">
                            <div _ngcontent-oko-c429 className="header">
                              <h2 _ngcontent-oko-c429>
                                <strong _ngcontent-oko-c429> Basic </strong>
                                Table
                              </h2>
                            </div>
                            <div _ngcontent-oko-c429 className="body table-responsive">
                              <table _ngcontent-oko-c429 className="table">
                                <thead _ngcontent-oko-c429>
                                  <tr _ngcontent-oko-c429>
                                    <th _ngcontent-oko-c429>#</th>
                                    <th _ngcontent-oko-c429>FIRST NAME</th>
                                    <th _ngcontent-oko-c429>LAST NAME</th>
                                    <th _ngcontent-oko-c429>USERNAME</th>
                                  </tr>
                                </thead>
                                <tbody _ngcontent-oko-c429>
                                  <tr _ngcontent-oko-c429>
                                    <th _ngcontent-oko-c429 scope="row">1</th>
                                    <td _ngcontent-oko-c429>Mark</td>
                                    <td _ngcontent-oko-c429>Otto</td>
                                    <td _ngcontent-oko-c429>@mdo</td>
                                  </tr>
                                  <tr _ngcontent-oko-c429>
                                    <th _ngcontent-oko-c429 scope="row">2</th>
                                    <td _ngcontent-oko-c429>Jacob</td>
                                    <td _ngcontent-oko-c429>Thornton</td>
                                    <td _ngcontent-oko-c429>@fat</td>
                                  </tr>
                                  <tr _ngcontent-oko-c429>
                                    <th _ngcontent-oko-c429 scope="row">3</th>
                                    <td _ngcontent-oko-c429>Larry</td>
                                    <td _ngcontent-oko-c429>the Bird</td>
                                    <td _ngcontent-oko-c429>@twitter</td>
                                  </tr>
                                  <tr _ngcontent-oko-c429>
                                    <th _ngcontent-oko-c429 scope="row">4</th>
                                    <td _ngcontent-oko-c429>Larry</td>
                                    <td _ngcontent-oko-c429>Jellybean</td>
                                    <td _ngcontent-oko-c429>@lajelly</td>
                                  </tr>
                                  <tr _ngcontent-oko-c429>
                                    <th _ngcontent-oko-c429 scope="row">5</th>
                                    <td _ngcontent-oko-c429>Larry</td>
                                    <td _ngcontent-oko-c429>Kikat</td>
                                    <td _ngcontent-oko-c429>@lakitkat</td>
                                  </tr>
                                </tbody>
                              </table>
                            </div>
                      ...
                      <div _ngcontent-oko-c429 className="row clearfix">
                        <div _ngcontent-oko-c429 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c429 className="card">
                            <div _ngcontent-oko-c429 className="header">
                              <h2 _ngcontent-oko-c429>
                                <strong _ngcontent-oko-c429> Striped </strong>
                                Rows
                              </h2>
                            </div>
                            <div _ngcontent-oko-c429 className="body table-responsive">
                              <table _ngcontent-oko-c429 className="table table-striped">
                                <thead _ngcontent-oko-c429>
                                  <tr _ngcontent-oko-c429>
                                    <th _ngcontent-oko-c429>#</th>
                                    <th _ngcontent-oko-c429>FIRST NAME</th>
                      ...
                      <div _ngcontent-oko-c429 className="row clearfix">
                        <div _ngcontent-oko-c429 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c429 className="card">
                            <div _ngcontent-oko-c429 className="header">
                              <h2 _ngcontent-oko-c429>
                                <strong _ngcontent-oko-c429> Bordered </strong>
                                Table
                              </h2>
                            </div>
                            <div _ngcontent-oko-c429 className="body table-responsive">
                              <table _ngcontent-oko-c429 className="table table-bordered">
                                <thead _ngcontent-oko-c429>
                                  <tr _ngcontent-oko-c429>
                                    <th _ngcontent-oko-c429>#</th>
                                    <th _ngcontent-oko-c429>FIRST NAME</th>
                      ...
                      <div _ngcontent-oko-c429 className="row clearfix">
                        <div _ngcontent-oko-c429 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c429 className="card">
                            <div _ngcontent-oko-c429 className="header">
                              <h2 _ngcontent-oko-c429>
                                <strong _ngcontent-oko-c429> Hover </strong>
                                Rows
                              </h2>
                            </div>
                            <div _ngcontent-oko-c429 className="body table-responsive">
                              <table _ngcontent-oko-c429 className="table table-hover">
                                <thead _ngcontent-oko-c429>
                                  <tr _ngcontent-oko-c429>
                                    <th _ngcontent-oko-c429>#</th>
                                    <th _ngcontent-oko-c429>FIRST NAME</th>
                      ...
                      <div _ngcontent-oko-c429 className="row clearfix">
                        <div _ngcontent-oko-c429 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c429 className="card">
                            <div _ngcontent-oko-c429 className="header">
                              <h2 _ngcontent-oko-c429>
                                <strong _ngcontent-oko-c429> Condensed </strong>
                                Table
                              </h2>
                            </div>
                            <div _ngcontent-oko-c429 className="body table-responsive">
                              <table _ngcontent-oko-c429 className="table table-condensed">
                                <thead _ngcontent-oko-c429>
                                  <tr _ngcontent-oko-c429>
                                    <th _ngcontent-oko-c429>#</th>
                                    <th _ngcontent-oko-c429>FIRST NAME</th>
                      ...
                      <div _ngcontent-oko-c429 className="row clearfix">
                        <div _ngcontent-oko-c429 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c429 className="card">
                            <div _ngcontent-oko-c429 className="header">
                              <h2 _ngcontent-oko-c429>
                                <strong _ngcontent-oko-c429> Colorful </strong>
                                Rows
                              </h2>
                            </div>
                            <div _ngcontent-oko-c429 className="body table-responsive">
                              <table _ngcontent-oko-c429 className="table table-condensed">
                                ...
                                <tbody _ngcontent-oko-c429>
                                  <tr _ngcontent-oko-c429 className="bg-purple">
                                    <th _ngcontent-oko-c429 scope="row">1</th>
                                    <td _ngcontent-oko-c429>Mark</td>
                                    <td _ngcontent-oko-c429>Otto</td>
                                    <td _ngcontent-oko-c429>@mdo</td>
                                  </tr>
                                  <tr _ngcontent-oko-c429 className="l-bg-green">
                                    <th _ngcontent-oko-c429 scope="row">2</th>
                                    <td _ngcontent-oko-c429>Jacob</td>
                                    <td _ngcontent-oko-c429>Thornton</td>
                                    <td _ngcontent-oko-c429>@fat</td>
                                  </tr>
                                  <tr _ngcontent-oko-c429 className="l-bg-orange">
                                    <th _ngcontent-oko-c429 scope="row">3</th>
                                    <td _ngcontent-oko-c429>Larry</td>
                                    <td _ngcontent-oko-c429>the Bird</td>
                                    <td _ngcontent-oko-c429>@twitter</td>
                                  </tr>
                                  <tr _ngcontent-oko-c429 className="l-bg-cyan">
                                    <th _ngcontent-oko-c429 scope="row">4</th>
                                    <td _ngcontent-oko-c429>Larry</td>
                                    <td _ngcontent-oko-c429>Jellybean</td>
                                    <td _ngcontent-oko-c429>@lajelly</td>
                                  </tr>
                                  <tr _ngcontent-oko-c429 className="l-bg-purple">
                                    <th _ngcontent-oko-c429 scope="row">5</th>
                                    <td _ngcontent-oko-c429>Larry</td>
                                    <td _ngcontent-oko-c429>Kikat</td>
                                    <td _ngcontent-oko-c429>@lakitkat</td>
