          ...
          <app-root _nghost-oko-c137 ng-version="15.2.0">
            ...
            <app-main-layout className="ng-star-inserted">
              ...
              <div dir="ltr">
                ...
                <app-gallery _nghost-oko-c462 className="ng-star-inserted">
                  <section _ngcontent-oko-c462 className="content">
                    <div _ngcontent-oko-c462 className="content-block">
                      <div _ngcontent-oko-c462 className="block-header">
                        <app-breadcrumb _ngcontent-oko-c462 _nghost-oko-c141>
                      ...
                      <div _ngcontent-oko-c462 className="row">
                        <div _ngcontent-oko-c462 className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <div _ngcontent-oko-c462 className="card">
                            <div _ngcontent-oko-c462 className="body">
                              <div _ngcontent-oko-c462 className="group-2">
                                <div _ngcontent-oko-c462>
                                  <img _ngcontent-oko-c462 className="ng-star-inserted" src="assets/images/image-gallery/1.jpg" />
                                  <img _ngcontent-oko-c462 className="ng-star-inserted" src="./assets/images/image-gallery/2.jpg" />
                                  <img _ngcontent-oko-c462 className="ng-star-inserted" src="../image-gallery/3.jpg" />
                                  <img _ngcontent-oko-c462 className="ng-star-inserted" src="../assets/images/image-gallery/4.jpg" />
                                  <img _ngcontent-oko-c462 className="ng-star-inserted" src="../assets/images/image-gallery/5.jpg" />
                                  <img _ngcontent-oko-c462 className="ng-star-inserted" src="../assets/images/image-gallery/6.jpg" />
                                  <img _ngcontent-oko-c462 className="ng-star-inserted" src="../assets/images/image-gallery/7.jpg" />
                                  <img _ngcontent-oko-c462 className="ng-star-inserted" src="../assets/images/image-gallery/8.jpg" />
                                  <img _ngcontent-oko-c462 className="ng-star-inserted" src="../assets/images/image-gallery/9.jpg" />
                                  <img _ngcontent-oko-c462 className="ng-star-inserted" src="../assets/images/image-gallery/10.jpg" />
                                  <img _ngcontent-oko-c462 className="ng-star-inserted" src="../assets/images/image-gallery/11.jpg" />
                                  <img _ngcontent-oko-c462 className="ng-star-inserted" src="../assets/images/image-gallery/12.jpg" />
                                  {/* */}
                                </div>
                              </div>
                              <ng-image-fullscreen-view _ngcontent-oko-c462>
                                {/* */}
