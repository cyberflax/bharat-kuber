                        ...
                        <button _ngcontent-hni-c131 aria-expanded="false" aria-haspopup="menu" className="mat-mdc-menu-trigger mdc-button mat-mdc-button mat-unthemed mat-mdc-button-base" mat-button>
                          ...
                          <span className="mdc-button__label">
                            <div _ngcontent-hni-c131 ngbdropdowntoggle>
                              <span _ngcontent-hni-c131>  Sarah Smith </span>
            ...
            <Accordion defaultActiveKey="0" >
              ...
              <Accordion.Item eventKey="16" style={{ margin: "auto", overflow: "hidden", width: "92%" }}>
                ...
                <Accordion.Body>
                  ...
                  <Dropdown.Item ><Link to="/Widgetdata" className='link1'> Data Widget</Link ></Dropdown.Item>
                ...
                <div _ngcontent-hni-c141 className="col-6">
                  <ul _ngcontent-hni-c141 className="breadcrumb-list">
                    <li _ngcontent-hni-c141 className="breadcrumb-item bcrumb-1">
                      <a _ngcontent-hni-c141 href="#/admin/dashboard/main">
        ...
        <div _ngcontent-hni-c142 className="row">
          ...
          <div _ngcontent-hni-c142 className="col-xl-4">
            ...
            <div _ngcontent-hni-c142 className="card-bnner">
              <div _ngcontent-hni-c142 className="row">
                <div _ngcontent-hni-c142 className="col-lg-6">
                  <img _ngcontent-hni-c142 alt="home1" src="../../assets/images/pages/home-1.png" />
                </div>
                <div _ngcontent-hni-c142 className="col-lg-6">
                  ...
                  <table _ngcontent-hni-c142 className="table table-hover">
                    ...
                    <tbody _ngcontent-hni-c142>
                      <tr _ngcontent-hni-c142>
                        ...
                        <td _ngcontent-hni-c142>
                          <img _ngcontent-hni-c142 alt="user1" className="user_img" src="../../assets/images/user/user1.jpg" />
                          John Doe
                        </td>
                      ...
                      <tr _ngcontent-hni-c142>
                        ...
                        <td _ngcontent-hni-c142>
                          <img _ngcontent-hni-c142 alt="user2" className="user_img" src="../../assets/images/user/user2.jpg" />
                          Sarah Smith
                        </td>
                      ...
                      <tr _ngcontent-hni-c142>
                        ...
                        <td _ngcontent-hni-c142>
                          <img _ngcontent-hni-c142 alt="user3" className="user_img" src="../../assets/images/user/user3.jpg" />
                          Airi Satou
                        </td>
                      ...
                      <tr _ngcontent-hni-c142>
                        ...
                        <td _ngcontent-hni-c142>
                          <img _ngcontent-hni-c142 alt="user4" className="user_img" src="../../assets/images/user/user4.jpg" />
                          Angelica Ramos
                        </td>
                      ...
                      <tr _ngcontent-hni-c142>
                        ...
                        <td _ngcontent-hni-c142>
                          <img _ngcontent-hni-c142 alt="user5" className="user_img" src="../../assets/images/user/user5.jpg" />
                          Ashton Cox
                        </td>
                      ...
                      <tr _ngcontent-hni-c142>
                        ...
                        <td _ngcontent-hni-c142>
                          <img _ngcontent-hni-c142 alt="user6" className="user_img" src="../../assets/images/user/user6.jpg" />
                          Cara Stevens
                        </td>
                      ...
                      <tr _ngcontent-hni-c142>
                        ...
                        <td _ngcontent-hni-c142>
                          <img _ngcontent-hni-c142 alt="user7" className="user_img" src="../../assets/images/user/user7.jpg" />
                          Jacob Ryan
                        </td>
