...
export default function Payslip() {
  ...
  return (
    ...
    <div _ngcontent-hni-c142 className={`  bg2 ${isOpen ? "bg2--open " : ""}`}>
                      <div _ngcontent-oko-c318 className="block-header">
                        <app-breadcrumb _ngcontent-oko-c318 _nghost-oko-c141>
                      ...
                      <div _ngcontent-oko-c318 className="row clearfix">
                        <div _ngcontent-oko-c318 className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                          <div _ngcontent-oko-c318 className="card">
                            <div _ngcontent-oko-c318 className="header">
                              <h2 _ngcontent-oko-c318>Payslip</h2>
                            </div>
                            <div _ngcontent-oko-c318 className="body">
                              <div _ngcontent-oko-c318 className="payslip">
                                <div _ngcontent-oko-c318 className="invoice-wrapper">
                                  <h4 _ngcontent-oko-c318 className="payslip-title">
                                    Payslip for the month of June 2022
                                  </h4>
                                  <div _ngcontent-oko-c318 className="payment-info">
                                    <div _ngcontent-oko-c318 className="row">
                                      <div _ngcontent-oko-c318 className="col-sm-6">
                                        <span _ngcontent-oko-c318>
                                          Payslip No.
                                        </span>
                                        <strong _ngcontent-oko-c318>
                                          859654
                                        </strong>
                                      </div>
                                      <div _ngcontent-oko-c318 className="col-sm-6 text-end">
                                        <span _ngcontent-oko-c318>
                                          Payment Date
                                        </span>
                                        <strong _ngcontent-oko-c318>
                                          Jul 02, 2022 - 12:30 am
                                        </strong>
                                      </div>
                                    </div>
                                  </div>
                                  <div _ngcontent-oko-c318 className="payment-details">
                                    <div _ngcontent-oko-c318 className="row">
                                      <div _ngcontent-oko-c318 className="col-sm-6">
                                        <img _ngcontent-oko-c318 className="mb-2" src="../../../../assets/images/logo.png" />
                                        <strong _ngcontent-oko-c318>
                                          EInfosoft Technology
                                        </strong>
                                        <p _ngcontent-oko-c318>
                                          52, Titanium software hub
                                          <br _ngcontent-oko-c318 />
                                          Gift city
                                          <br _ngcontent-oko-c318 />
                                          Gandinagar
                                          <br _ngcontent-oko-c318 />
                                  ...
                                  <div _ngcontent-oko-c318 className="line-items">
                                    <div _ngcontent-oko-c318 className="row">
                                      <div _ngcontent-oko-c318 className="col-sm-6">
                                        <div _ngcontent-oko-c318>
                                          <p _ngcontent-oko-c318 className="extra-notes">
                                            <strong _ngcontent-oko-c318>
                                              Earnings
                                            </strong>
                                          </p>
                                          <table _ngcontent-oko-c318 className="table table-bordered">
                                            <tbody _ngcontent-oko-c318>
                                              <tr _ngcontent-oko-c318>
                                                <td _ngcontent-oko-c318>
                                                  <strong _ngcontent-oko-c318>
                                                    Basic
                                                  </strong>
                                                  <span _ngcontent-oko-c318 className="float-end">
                                                    $8,568
                                                  </span>
                                                </td>
                                              </tr>
                                      ...
                                      <div _ngcontent-oko-c318 className="col-sm-12">
                                        <div _ngcontent-oko-c318 className="col-sm-12">
                                          <span _ngcontent-oko-c318 className="fw-bold">
                                            Net Pay : 8,552.00
                                          </span>
                                          <br _ngcontent-oko-c318 />
                                          <br _ngcontent-oko-c318 />
                                    ...
                                    <div _ngcontent-oko-c318 className="d-flex justify-content-end">
                                      <div _ngcontent-oko-c318 className="d-flex flex-column mt-2">
                                        <span _ngcontent-oko-c318 className="fw-bolder">
                                          For Priya Jain
                                        </span>
                                        <span _ngcontent-oko-c318 className="mt-4">
                                          Authorised Signatory
                                        </span>
                                      </div>
                                    </div>
                                    <div _ngcontent-oko-c318 className="print">
                                      <a _ngcontent-oko-c318 href onclick="return false;">
                                        <i _ngcontent-oko-c318 className="fa fa-print">
                                        </i>
                                        Print this receipt
                                      </a>
                                    </div>
