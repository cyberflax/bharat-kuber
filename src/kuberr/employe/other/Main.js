...
export function Main()
{
  ...
  <app-root _nghost-wjc-c137="" ng-version="15.2.0">
    <app-page-loader _ngcontent-wjc-c137="" _nghost-wjc-c136="">
      <ngx-loading-bar
        _ngcontent-wjc-c136=""
        _nghost-wjc-c135=""
        color="#3173D6"
    ...
    <router-outlet _ngcontent-wjc-c137=""></router-outlet>
    <app-auth-layout className="ng-star-inserted">
      <div dir="ltr">
        <router-outlet></router-outlet>
        <app-signin _nghost-wjc-c138="" className="ng-star-inserted">
          <div _ngcontent-wjc-c138="" className="auth-container">
            <div _ngcontent-wjc-c138="" className="row auth-main">
              <div
                _ngcontent-wjc-c138=""
              ...
              >
                <div _ngcontent-wjc-c138="" className="form-section">
                  <div _ngcontent-wjc-c138="" className="auth-wrapper">
                    <h2 _ngcontent-wjc-c138="" className="welcome-msg">
                      Welcome to Kuber
                    </h2>
                    <p
                      _ngcontent-wjc-c138=""
                    ...
                    <h2 _ngcontent-wjc-c138="" className="login-title">
                      Sign in
                    </h2>
                    <form
                      _ngcontent-wjc-c138=""
                      ...
                      noValidate=""
                    >
                      <div _ngcontent-wjc-c138="" className="row">
                        <div
                          _ngcontent-wjc-c138=""
                      ...
                      >
                        <div _ngcontent-wjc-c138="" className="form-check">
                          <label
                            _ngcontent-wjc-c138=""
                    ...
                    <h6 _ngcontent-wjc-c138="" className="social-login-title">
                      OR
                    </h6>
                    <ul
                      _ngcontent-wjc-c138=""
                    ...
                    >
                      <li _ngcontent-wjc-c138="" className="list-inline-item">
                        <a
                          _ngcontent-wjc-c138=""
                          className="rounded"
