...
function Dashmain() {
  ...
  return (
      ...
      <div class="light menu_light logo-white theme-white">
                  ...
                  <div _ngcontent-woo-c227="" className="row auth-main">
                    ...
                    >
                      <div
                        ...
                        className="left-img"
                        style={{
                          backgroundImage: "url(assets/images/pages/bg-01.png)", position:"relative"
                      }}
                        ...
                        <div _ngcontent-woo-c227="" className="auth-wrapper">
                          ...
                          >
                            <div _ngcontent-woo-c227="">
                              ...
                              <span className="mdc-button__label"><Link to="/Main" style={{color:"white"}}>Admin</Link></span>
                            ...
                            <div _ngcontent-woo-c227="">
                              ...
                              >
                                <span className="mat-mdc-button-persistent-ripple mdc-button__ripple"></span>
                              <span className="mdc-button__label"><Link to="/employedashboard" style={{ color: "white" }}>Employee</Link></span>
                                <span className="mat-mdc-focus-indicator"></span>
                                <span
                                  className="mat-ripple mat-mdc-button-ripple"
                                  matripple=""
                            ...
                            <div _ngcontent-woo-c227="">
                              ...
                              >
                                <span className="mat-mdc-button-persistent-ripple mdc-button__ripple"></span>
                              <span className="mdc-button__label"><Link to="/Clientdash" style={{ color: "white" }}>Client</Link></span>
                                <span className="mat-mdc-focus-indicator"></span>
                                <span
                                  className="mat-ripple mat-mdc-button-ripple"
                                  matripple=""
